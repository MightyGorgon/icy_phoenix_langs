...
<b>{POSTERNAME}</b> ha enviado un nuevo tema llamado <b>"{TOPIC_TITLE}"</b> en el foro <b>"{FORUM_NAME}"</b> de <b>{SITENAME}</b>.<br /><br />
Puede usar el siguiente enlace para ver el tema:<br /><br />
