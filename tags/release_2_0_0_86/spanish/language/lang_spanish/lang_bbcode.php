...
$faq[] = array("&iquest;Qué es el código BBCode?", "BBCode es una implementación especial del HTML. La forma en la que puede usarse BBCode la determina el administrador. Es muy similar al HTML, las etiquetas van entre corchetes [ y ].");
...
$faq[] = array("--", "Otros");
$faq[] = array("&iquest;Puedo agregar mis propias etiquetas?", "No, no en esta versión de Icy Phoenix; seguramente será posible en versiones posteriores.");
