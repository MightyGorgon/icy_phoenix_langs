...
*/
	...
	'ctracker_login_confim' => 'Antalet felaktiga Inloggningar för ditt konto har uppnåtts. Därför är ditt konto läst och kommer att behövas återaktiveras genom att du använder Visuell Bekräftelse.<br /><br />Vänligen skriv in följande kod och klicka på "Läs upp" för att läsa upp ditt konto. När detta är gjort kan du logga in på nytt.',
...
*/
	...
	'ctracker_ipwarn_welc' => '<b>&raquo; RÅDGIVNING &laquo;</b><br />IP Range Scanner för ditt konto har inte påbörjats ännu. Detta sker efter två Inloggningar. Om du vill initiera Scanner nu, logga då in och ut två gånger.',
...
*/
	...
	'ctracker_gmb_mark' => 'Markera läst post',
