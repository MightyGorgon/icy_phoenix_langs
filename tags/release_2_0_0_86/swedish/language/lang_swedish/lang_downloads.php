...
*/
	...
	'Dl_comments_delete' => 'Radera kommentarer',
	'Dl_comments_delete_all' => 'Radera alla kommentarer',
	'Dl_cat_traffic' => 'Trafik citering (förnärvarande tillgänglig: %s)',
	'Dl_cat_traffic_off' => 'Trafik citering (förnärvarande av)',
	'Dl_cat_traffic_main' => '%s trafik finns kvar i denna kategori',
...
* traffic related
*/
	'Dl_auto_traffic' => 'Automatiskt nerladda trafik',
	'Dl_enable_post_traffic' => 'Möjliggör trafik tillägg för inlägg',
	'Dl_group_auto_traffic' => 'Trafik för användargrupper',
	'Dl_newtopic_traffic' => 'Ladda ner trafik för varje nytt skapat ämne',
	...
	'Dl_reply_traffic' => 'Ladda ner trafik för varje post, svar eller citat',
	'Dl_traffic' => 'Max. trafik',
	'Dl_user_auto_traffic' => 'Trafik för användare',
	'Single_user_traffic_title' => 'Trafik för en enskild användare',
	'Traffic' => 'Traffic',
	...
	'Dl_user_traffic_once' => 'Minska användare trafik endast en gång per nedladdning',
	'Dl_can_download_traffic' => 'Du har redan laddat ner den här filen.<br />Administratören tillåter dig att ladda ner igen utan att betala trafik för den.',
	'Dl_can_download_traffic_footer' => '<b>Administratören tillåter dig att ladda redan nedladdade filer igen utan att betala trafik för dem.</b><br /><br />',
	'Traffic_all_users_admin_explain' => 'Lägg till eller ställ in trafik för alla användare.',
	'Traffic_single_user_admin_explain' => 'Lägg till eller ställ in trafik för en enda användare.',
	'Traffic_usergroup_admin_explain' => 'Lägg till eller ställ in trafik för alla medlemmar i en användargrupp.',
	'Dl_auto_traffic_explain' => 'Ställ in trafik för alla användare eller alla medlemmar i en användargrupp vad de får ladda ner varje månad.',
...
*/
	...
	'Dl_ip' => 'IP Adress',
	'Dl_traffic_cur_month' => 'Trafik denna månad',
	'Dl_traffic_overall' => 'Trafik totalt',
...
*/
	'Dl_acp_traffic_management' => 'Hantera trafik kvoter och auto förinställningar',
...
* global strings
*/
	'Dl_account' => 'Du har kvar <b>%s</b> trafik denna månad.',
	...
	'Dl_delay_auto_traffic' => 'Försena auto trafik för ny Användare',
	'Dl_delay_post_traffic' => 'Försena trafik för inlägg för ny Användare',
...
*/
	'Dl_cash_to_traffic' => 'Växla kontanter till trafik',
	'Dl_cash_to_traffic_explain' => 'Ställ in mellan kontant valuta och Ladda Ner trafik. Utbytet kommer att förändras till fulla värdet av den valuta till hela beloppet på trafik.',
	'Dl_cash_currency' => 'Kontant valuta',
	'Dl_cash_exchange' => 'Växla: 1 %s till %s trafik',
