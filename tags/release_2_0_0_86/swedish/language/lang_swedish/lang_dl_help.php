...
*
* @package Icy Phoenix
* @version $Id: lang_dl_help.php 55 2009-08-07 09:20:40Z Mighty Gorgon $
...
*/
	...
	'HELP_Dl_is_free' => 'Aktivera denna funktion om nedladdningen bör vara gratis att ladda ner för alla.<br />Trafik konton kommer inte att användas.<br />Välj gratis för reg. Användare och gör det möjligt för en gratis nedladdning endast för registrerade användare.',
	'HELP_Dl_traffic' => 'Den högsta trafik fil kommer att tillåtas att producera.<br />Värdet 0 inaktiveras Trafik kontroll',
