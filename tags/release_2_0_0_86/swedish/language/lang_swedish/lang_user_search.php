...
$lang = array_merge($lang, array(
	...
	'Search_invalid_lastvisited' => 'Ogiltig data angavs för senaste besöks sökning',
	'Search_invalid_language' => 'Ogiltigt språk valts',
	...
	'Search_username_explain' => 'Här kan du utföra ett skiftlägesokänsligg sökning efter användarnamn. Om du vill söka på del av användarnamn, använda * (asterisk) som jokertecken. Kontrollera Regular Expressions box gör att du kan söka utifrån dina regex mönster. <strong>Notera:</strong> Regular Expressions fungerar bara i MySQL, PostgreSQL och Oracle 10g+.',
	...
	'Search_users_moderators_explain' => 'Sök användare med Moderations rättigheter till ett särskilt forum. Moderations rättigheter redovisas antingen genom användarbehörigheter eller genom att vara i en grupp med rätt Grupp Rättigheter.',
