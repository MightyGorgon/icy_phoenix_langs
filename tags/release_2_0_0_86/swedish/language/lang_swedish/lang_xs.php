...
$lang = array_merge($lang, array(
	'Extreme_Styles' => 'eXtreme Stilar',
	'xs_title' => 'eXtreme Stils mod',
...
* frame_top.tpl
*/
	'xs_menu_lc' => 'extrema stilar mod meny',
...
*/
	...
	'xs_default_style_explain' => 'Ändra standard forum stilen och ändra över från en stil till en annan.',
	...
	'xs_edit_styles_data_explain' => 'Redigera stil variabler. Det används av vissa stilar, men de flesta stilar använder en css-fil i stället.',
...
*/
	...
	'xs_ftp_error_fatal' => 'FTP funktioner är avstängda på den här servern. Kan inte fortsĆ¤tta.',
...
*/
	...
	'xs_config_title' => 'eXtreme Styles mod {VERSION} inställningar',
...
// Debug info
	...
	'xs_check_ok' => 'Öppnar fil "%s" för skrivning. Allt verkar vara ok.',
...
*/
	...
	'xs_cache_confirm' => 'Om du har många stilar kan detta vålla stora server belastningar. Är du säker på att du vill fortsätta?',
...
*/
	...
	'xs_uninstall_styles_explain2' => 'Detta är en lista över stilar som är installerade på ditt forum. Klicka på "avinstallera" länken för att ta bort vissa stilar från forumet. Avinstallation är säker - alla användare som använder stilarna som avinstallerats kommer att kopplas om till standard forum stilen. Också avinstalleraren kommer automatiskt att ta bort cachen för stilen.',
...
*/
	'xs_export_styles_data_explain2' => 'Denna funktion sparar stil uppgifter i theme_info.cfg. Det kan användas för att spara databasinformation innan stilar från ett forum till ett annat överlåtes.<br /><br />Notera: Om du använder eXtreme Styles export-funktionen för att flytta ett format till ett annat forum behöver du inte spara theme_info.cfg - det görs automatiskt av stil export funktionen.',
...
*/
	...
	'xs_data_unknown' => 'Beskrivningen är inte tillgä¤nglig (%s)',
...
*/
	...
	'xs_update_info1' => 'Denna administratörs funktionen söker efter tillgängliga uppdateringar av phpBB vissa mods, och vissa stilar installerade på ditt forum. När det finns tillgängliga uppdateringar visar den länken där du kan ladda ner den uppdaterade filen.<br /><br />Den här funktionen kräver att sockets ska vara aktiverad. De flesta gratis webbhotellen har inte denna funktion, så om detta forum ligger på en fri värd (som Lycos) så kan du inte använda funktionen, men om detta forum ligger på normal server bör allt vara okej.<br /><br />När du klickar på "Fortsätt" kommer skriptet att kontrollera all programvara som är installerad på forumet. Om din webbplats är långsam kan det ta lite tid. Ha tålamod och klicka inte på "stopp" i din webbläsare om processen försenas. Om servern är långsam eller uppdatera webbplatsen är långsam då kan skriptet ta timeout - Om detta inträffar bör du öka timeout-värdet.',
	'xs_update_name' => 'Namn',
	'xs_update_type' => 'Typ',
