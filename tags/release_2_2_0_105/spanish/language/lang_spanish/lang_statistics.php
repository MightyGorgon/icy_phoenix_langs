...
// 'Version_info' => '<br />Versión del MOD de estadísticas %s', //%s = number
	'Version_info' => '<br />Estadísticas recodificadas por <a href="http://www.icyphoenix.com/">Mighty Gorgon</a> basado en el MOD de estadísticas, versión %s &copy; 2002 <a href="http://www.opentools.de/board">Acyd Burn</a>',
...
// Statistics Config
	...
	'Return_limit_desc' => '<b>El número de objetos a incluir en cada rango.</b><br /> Esto es automático para todos los módulos especificados aquí.',
	'Clear_cache' => 'Limpiar el caché de los módulos',
	'Clear_cache_desc' => 'Check Box para borrar todos los archivos de caché actuales de todos los módulos',
...
// Modules Management
	...
	'AUTO_SET_UPDATE_TIME' => '<b>Determina y fija el tiempo recomendado para cada instalación (y activación) de los módulos. ATENCIóN: puede ser largo.</b>',
...
// Modules
	...
	'Board_Up_Days' => 'Días del Foro funcionando',
	...
	'Avg_Table' => 'Media de Tabla',
	'Sum_Table' => 'Suma de Tabla',
	...
	'module_name_users_from_where' => 'Ubicación de los usuarios',
