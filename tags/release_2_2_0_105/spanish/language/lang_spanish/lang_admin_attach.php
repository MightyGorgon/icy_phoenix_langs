...
// Attachments -> Management
	...
	'Attach_quota' => 'Cuota total de adjuntos',
	...
	'Disable_mod' => 'Deshabilitar MOD de adjuntos',
	...
	'Ftp_server_explain' => 'Aquí puede ingresar la IP o el nombre del servidor para subir archivos. Si deja esto en blanco se usará el servidor donde está el phpBB2. No está habilitado ftp:// ni nada parecido, sólo la dirección plana, ejemplo ftp.foo.com o la dirección IP (así es mucho mas rápido).',

	'ftp_username' => 'Su usuario FTP',
	'ftp_password' => 'Su contraseña FTP',

	'Attach_ftp_path' => 'Ubicación del FTP para el directorio de subida',
	...
	'Ftp_download_path' => 'Enlace de descarga ubicación FTP',
...
// Attachments -> Sync
	...
	'Sync_topics' => 'Sincronizar Temas',
	'Sync_posts' => 'Sincronizar Mensajes',
	'Sync_thumbnails' => 'Sincronizar Miniaturas',
...
// Control Panel -> Search
	...
	'Size_greater_than' => 'amaño mayor que (bytes)',
	'Count_smaller_than' => 'Contador de descargas menor a',
	'Count_greater_than' => 'Contador de descargas mayor a',
	'More_days_old' => 'Que tenga más de esta cantidad de días de antigüedad',
	'No_attach_search_match' => 'NNo se ha encontrado ningún adjunto con las características que buscó',
