...
$lang = array_merge($lang, array(
	...
	'ACL_TYPE_U_' => 'Permisos de Usuarios',
	...
	'ACL_TYPE_LOCAL_CMSS_' => 'Permisos paginas CMS estandar',
	'ACL_TYPE_LOCAL_CMSB_' => 'Permisos Bloques CMS',
	'ACL_TYPE_LOCAL_F_' => 'Permisos de Foro',
	'ACL_TYPE_LOCAL_M_' => 'Permisos de moderadores de foro',
	...
	'LOOK_UP_CMS_L' => 'Seleccionar página',
	'LOOK_UP_CMS_L_EXPLAIN' => 'El nombre de la Página es seguido de la ID de la página entre corchetes con un número de referencia',
	'LOOK_UP_CMS_S' => 'Selecionar pagina estandar',
	...
	'ONLY_FORUM_DEFINED' => 'olo definiste foros en su selección. Por favor, también selecciona al menos un usuario o un grupo.',
	...
	'ROLE_DESCRIPTION_FORUM_ONQUEUE' => 'Puede usar algunas de las funciones de los foros incluyendo adjuntos, pero mensajes y temas necesitan ser aprobados por un moderador.',
	...
	'SELECTED_LAYOUT_NOT_EXIST' => 'La(s) página(s) CMS seleccionada(s) no existe(n).',
	'SELECTED_LAYOUT_SPECIAL_NOT_EXIST' => 'La(s) página(s) estandard seleccionada (s) no existe(n).',
	...
	'TRACE_USER_FOUNDER' => 'TEl usuario es un fundador, por lo tanto los permisos del admin pasan a ser <samp>SÍ</samp> por defecto.',
