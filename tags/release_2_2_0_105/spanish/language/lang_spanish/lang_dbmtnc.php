...
$mtnc[] = array('check_user',
	...
	'Usted perderá todos los grupos sin algún usuario al realizar esta acción. &iquest;Desea continuar?',
	0);
$mtnc[] = array('check_post',
	...
	'Usted perderá todos los mensajes sin texto. &iquest;Desea continuar?',
	0);
$mtnc[] = array('check_vote',
	'Comprobar tablas de votos',
	'Esto comprobará las tablas de votos para saber si hay errores.',
	'Usted perderá todos los datos de voto sin un voto correspondiente. &iquest;Desea continuar?',
	0);
$mtnc[] = array('check_pm',
	'Comprobar tablas de mensajes privados',
	'Esto comprobará las tablas de mensajes privados para saber si hay errores.',
	'Los mensajes sin leer serán eliminados cuando no exista el remitente o el receptor. &iquest;Desea continuar??',
	0);
...
$mtnc[] = array('check_search_wordlist',
	...
	'Esta función puede llevar un cierto tiempo para ejecutarse. No es necesario realizar esta comprobación, pero hacerla puede reducir un poco el tamaño de la base de datos. &iquest;Desea continuar?',
	0);
$mtnc[] = array('--', '', '', '', 0);
$mtnc[] = array('synchronize_post',
	...
	'Este comando puede llevar un cierto tiempo para terminar. Si su servidor no permite el uso del comando set_time_limit(), este comando puede ser interrumpido por PHP. Ningún dato se perderá por esto, pero ciertos datos pueden no ser actualizados. &iquest;Desea continuar?',
	0);
$mtnc[] = array('synchronize_user',
	'SSincronizar contadores de mensajes del usuario',
	'Esto sincronizará los contadores de mensaje para los usuarios.',
	'b>Atención:</b> Los mensajes borrados por el PRUNE, normalmente no son restados del contador de mensajes. Al hacer correr este comando, los mensajes eliminados por el PRUNE del foro serán restados del contador y no podrán ser restaurados. &iquest;Desea continuar?',
	6);
...
$mtnc[] = array('reset_date',
	...
	'En cualquier momento de un mensajes para el futuro será fijado al tiempo actual. &iquest;Desea continuar?',
	0);
$mtnc[] = array('reset_sessions',
	...
	'Todos los usuarios activos perderán su sesión actual y sus resultados de búsqueda. &iquest;Desea continuar?',
	0);
$mtnc[] = array('--', '', '', '', 8);
$mtnc[] = array('sync_topics_subjects',
	...
	'Esto sincronizará los títulos de los temas del primer mensaje en todo el tema. El foro no estará disponible mientras dure el proceso. &iquest;Desea proceder?',
	0);
$mtnc[] = array('synchronize_notify_forum_id',
	'Sincronizar las IDs de los foros para las Notificaciones',
	'Esta función va a actualizar las ID de los foros en la tabla de notificaciones de temas. No debería que usar esta función en condiciones normales.',
	'',
	0);
$mtnc[] = array('rebuild_search_index',
	...
	'Esto suprimirá el índice de búsqueda por completo y lo reconstruirá. Esto puede llevar varias horas hasta completar la tarea. El foro no será accesible durante este período. &iquest;Desea continuar?',
	7);
...
$mtnc[] = array('repair_db',
	...
	'YSólo debe realizar esta acción si hay un informe de error en la comprobación de la base de datos. &iquest;Proceder?',
	1);
$mtnc[] = array('--', '', '', '', 0);
...
// statistic
	...
	'Thereof_phpbb_core' => 'de esas tablas Icy Phoenix',
	'Thereof_phpbb_advanced' => 'de esas tablas avanzadas de Icy Phoenix',
	'Version_of_board' => 'Version del foro Icy Phoenix',
...
// config
	...
	'Rebuildcfg_Minposts_Explain' => 'El mantenimiento de la BD utiliza un método avanzado para la indexación cuando están disponibles PHP 4.0.5 o posteriores. Puede apagar el método avanzado, de modo que el mantenimiento de la BD haga uso el método estándar del foro.',
...
// check_user
	...
	'Default_theme_invalid' => 'El estilo por defecto es inválido. Por favor, compruebe la configuración.',
	...
	'Changing_language' => 'Cambiar lenguaje \'%s\' to \'%s\'',
...
// check_post
	...
	'Checking_invalid_posts' => 'Comprobar mensajes con temas inválidos',
	'Invalid_posts_found' => 'Mensajes con temas inválidos encontrados',
	...
	'Setting_post_forum' => '%d: mover desde el foro \'%s\' (%d) to \'%s\' (%d)',
	...
	'Updating_topic' => 'Actualizar tema %d (Poster: %d -&gt; %d)',
...
// rebuild last poster details
	'Rebuild_Last_Poster_Details' => 'Reconstruyendo detalles del último escritor',
// check_vote
...
// check_pm
	...
	'Invalid_pm_recipients_found' => 'Mensajes privados con receptores inválidos encontradost',
...
// rebuild_search_index
	...
	'Reset_search_autoincrement' => 'Resetear el contador de las tablas de búsqueda',
...
// synchronize_post
	...
	'Synchronize_topic_data' => 'SSincronizar temas',
...
// synchronize_user
	...
	'Synchronize_user_post_counter' => 'Sincronizar contador de mensajes de los usuarios',
...
// reset_sessions
	...
	'Restoring_session' => 'RRestaurar sesión de usuario activo',
// check_db
...
// Emergency Recovery Console
	...
	'Return_ERC' => 'RVolver a la consola de recuperación de emergencia',
	'cur_setting' => 'Configuración actual',
	'rec_setting' => 'nfiguración recomendada',
	'secure' => 'Seguro',
	'secure_yes' => 'si (https)',
	'secure_no' => 'no (http)',
	'domain' => 'Dominio',
...
// Options
	...
	'rcd' => 'Actualizar los datos de la cookiea',
...
// Info for options
	...
	'ecf_info' => 'Cuando proceda el directorio caché será limpiado.',
	...
	'rtd_info_no_theme' => 'Cuando proceda, el tema por defecto (icy_phoenix) será reconstruido y utilizado tanto para el foro como para el usuario usado para autentificar.',
