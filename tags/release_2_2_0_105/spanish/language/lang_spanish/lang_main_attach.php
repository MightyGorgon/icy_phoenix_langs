...
/*
	'Rules_attach_can' => '<b>Puede</b> adjuntar archivos en este foro',
	'Rules_attach_cannot' => '<b>No puede</b> adjuntar archivos en este foro',
	'Rules_download_can' => '<b>Puede</b> descargar archivos en este foro',
	'Rules_download_cannot' => '<b>No puede</b> descargar archivos en este foro',
*/
	...
	'Sorry_auth_view_attach' => 'Lo siento pero no está autorizado para ver o descargar estos Adjuntos',
...
// Errors -> Posting Attachments
	...
	'Attachment_php_size_na' => 'El archivo es muy grande.<br />No se pudo determinar cuánto es el máximo soportado por php.<br />El File Attachment mod no pudo determinar el tamaño máximo en el php.ini',
	'Attachment_php_size_overrun' => 'El archivo es muy grande.<br />El tamaño máximo de subida son %d MB.<br />Este tamalo lo define el php.ini, por lo que el Attachment MOD no pueda pasar ese tamaño', // replace %d with ini_get('upload_max_filesize')
	'FileType_Mismatch' => 'Tipo de archivo no válido',
	'Disallowed_extension' => 'La extensión %s no está permitida', // replace %s with extension (e.g. .php)
	'Disallowed_extension_within_forum' => 'No puede publicar mensajes con adjuntos con la extensión %s en este sitio', // replace %s with the Extension
	...
	'Attach_quota_reached' => 'Lo siento, pero ha alcanzado la capacidad total de adjuntos. Comuníquese con un administrador para mas información.',
...
// Errors -> PM Related
	'Attach_quota_sender_pm_reached' => 'Lo siento, pero ha alcanzado el límite de mensajes privados en sus carpetas. Por favor, borre algunos adjuntos de su carpeta enviados, por ejemplo.',
	'Attach_quota_receiver_pm_reached' => 'Lo siento, pero el destinatario ha alcanzado el límite de mensajes privados en sus carpetas. Avísele de que borre algo para poder enviarle los archivos.',

// Errors -> Download
	'No_attachment_selected' => 'YNo ha seleccionado un archivo para ver o descargar',
...
// Delete Attachments
	...
	'Confirm_delete_pm_attachments' => '¿Está seguro de que desea borrar todos los archivos adjuntos que hay en este mensaje privado??',
...
// Quota Variables
	...
	'User_upload_quota_reached' => 'Lo siento, pero ha alcanzado el límite de su cuota de %d %s', // replace %d with Size, %s with Size Lang (MB for example)
