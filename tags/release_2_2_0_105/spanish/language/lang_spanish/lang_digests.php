...
// This block goes as default text in the emailed digest (mail_digests.php)
	'digest_introduction' => 'Como usted solicitó, aquí está el resumen de los últimos mensajes enviados a los foros de ' . $config['sitename'] . 'Por favor, puede entrar en la discusión',
	'digest_from_text_name' => $config['sitename'] . ' robot de resumen',
	'digest_from_email_address' => $config['Tablón de Correo Electrónico'],
	'digest_subject_line' => $config['sitename'] . ' Resumen',
	'digest_disclaimer_html' => "\n" . 'Este resumen se está enviando a los usuarios registrados de los foros de <a href="' . DIGEST_SITE_URL . '">' . $config['sitename'] . '</a> y solamente porque usted lo solicito explícitamente. ' . $config['sitename'] . ' es completamente gratuito. Su dirección de correo nunca será entregada a terceras partes. Vea nuestras <a href="' . DIGEST_SITE_URL . 'faq.' . PHP_EXT . '">FAQ</a> para más información sobre nuestra política de privacidad. Puede cambiar o borrar su suscripción, identificándose en ' . $config['sitename'] . ' en la <a href="' . DIGEST_SITE_URL . 'digests.' . PHP_EXT . '">Página de resúmenes</a> (debe estar identificado para cambiar sus ajustes de resumen.) Si tiene alguna pregunta sobre el formato de este resumen, por favor, contacte con el <a href="mailto:' . $config['board_email'] . '">' . $config['sitename'] . ' administrador</a>.',
	'digest_disclaimer_text' => "\n" . 'Este resumen se está enviando a los usuarios registrados de los foros de ' . $config['sitename'] . ' y solamente porque usted lo solicito explícitamente. ' . $config['sitename'] . ' es completamente gratuito. Su dirección de correo nunca sera entregada a terceras partes. Vea nuestras FAQ para más información sobre nuestra política de privacidad. Puede cambiar o borrar su suscripción, identificándose en ' . $config['sitename'] . ' en la página de resúmenes (debe estar identificado para cambiar sus ajustes de resumen.) Si tiene alguna pregunta sobre el formato de este resumen, por favor contante con el ' . $config['board_email'] . '.',
	'digest_forum' => 'Foro: ',
	'digest_topic' => 'Tema: ',
	'digest_link' => 'Enlace',
...
// This block goes on the digest settings user interface page (digests.php)
	...
	'digest_explanation' => 'Esta lista de correo es, básicamente, un e-mail enviado al usuario con los mensajes enviados a los foros, y que usted recibirá periódicamente. Los resúmenes pueden ser enviados diaria o semanalmente, en la hora del día que usted seleccione. Puede especificar los foros del sitio de los que quiere resúmenes, o puede elegir recibir todos los mensajes de todos los foros a los que tenga acceso.<br /><br />' . "\n" . 'Considerando la política de privacidad, los correos no contienen "SPAM", ni su dirección de correo será usada de ninguna forma ni remitida a terceras personas. Por supuesto, puede cancelar en cualquier momento su cuenta, simplemente volviendo a esta página. Muchos usuarios encuentran estos resúmenes muy útiles, desde aquí le animamos a que los pruebe!' . "\n",
	...
	'digest_10pm' => '10 PM',
	'digest_11pm' => '11 PM',
	'digest_click_return' => 'Pulse %saqui%s para volver a las configuraciones de resumenes', // %s's here are for uris, do not remove!
