...
/* Language Strings used for the ACP Menu points */
	...
	'ctracker_module_11' => 'Pié de Página',
...
/* Language Strings used in ACP Modules itself */
	...
	'ctracker_set_catname1' => 'IBloquear IP, proxy y agente de usuario',
	...
	'ctracker_settings_expl' => '<b>Aquí puede modificar todos los ajustes para requisitos generales del sistema de seguridad de CBACK CrackerTracker.</b>',
	...
	'ctracker_settings_e32' => 'Cuando se activa esta característica, los invitados tienen que introducir un código visual para escribir nuevos mensajes. De no ser así, no podrán enviar el mensaje. Esto protege contra los spambots automáticos.',
...
/* File Safety Scanner in ACP */
	...
	'ctracker_fscan_prob_2' => 'IP_root_path quizá no se inicializó correctamente',
	'ctracker_fscan_prob_3' => 'common.php / pagestart.php quizá no fue incluido o demasiado tarde',
	'ctracker_fscan_prob_4' => 'El código en el archivo es posiblemente ejecutable más allá de ICY_Phoenix',
...
*/
	...
	'ctracker_glob_msg_subhead' => '<b>Aquí puede dejar un mensaje global a todos los usuarios.</b><br /> Este mensaje lo verán los usuarios en su siguiente identificación. Puede referirlo a un mensaje ya existente o escribir su propio texto.<br /><b>Nota:</b> Hay un límite impuesto de (255 caracteres)',
	...
	'ctracker_glob_res_txt' => 'WSi pulsa en "Cancelar mensaje actual", el mensaje guardado se cancelará.',
...
*/
	...
	'ctracker_ipb_head' => 'PBloquear proxy, IP y agente de usuario',
...
*/
	'ctracker_ma_unknown' => '<span class="text_orange">DESCONOCIDO</span>',
	'ctracker_ma_secure' => '<span class="text_green">SEGURO</span>',
	'ctracker_ma_warning' => '<span class="text_red">CUIDADO</span>',
	'ctracker_ma_active' => '<span class="text_green">ACTIVO</span>',
	'ctracker_ma_inactive' => '<span class="text_red">NO ACTIVO</span>',
	'ctracker_ma_ca' => '<span class="text_green">OK</span>',
	'ctracker_ma_ci' => '<span class="text_red">NO FIJADO</span>',
	...
	'ctracker_ma_scheck_4' => 'Versión Icy Phoenix (<a href="http://www.icyphoenix.com" target="_blank">Visite el sitio</a>)',
...
*/
	...
	'ctracker_rec_backup' => '<span class="gen">Copia de seguridad de la tabla de configuración</span>',
	'ctracker_rec_restore' => '<span class="gen">Recuperar la última tabla de configuración que funcionó</span>',
	'ctracker_rec_succ' => '<span class="gen">El proceso en la base de datos se ejecutó correctamente.</span>',
	'ctracker_rec_pab' => '<span class="gen">La recuperación no está disponible, antes debe usted crear una copia de seguridad correcta!</span>',
	)
);
?>