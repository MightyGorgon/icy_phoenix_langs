...
// 07 - Clear Cache
	...
	'Album_clear_cache_confirm' => 'Si usa la caché debe borrarla después de efectuar cambios en la configuración del álbum.<br /><br /> &iquest;Quiere borrarla ahora?',
...
// ACP - Javascript text
	...
	'acp_settings_changed_ask_save' => 'Ha cambiado la configuración. &iquest;Quiere guardarla?\n(OK = Si, Cancel = No)',
...
// CLowN
	...
	'SP_Hon_where' => '&iquest;Mostrar imágenes &iquest;Caliente? de qué categorías? (dejar en blanco para usar imágenes de todas las categorías; si son mas de una, separarlas por comas)',
