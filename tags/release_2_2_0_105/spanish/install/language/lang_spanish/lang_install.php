...
$lang = array_merge($lang, array(
    ...
    'FixPosts_IP2' => 'Arreglar temas (Actualizando desde Icy Phoenix 1.3)',
	'FixPosts_IP2_Explain' => 'Esta Funcion te permite ajustar la ruta de los Imagenes subidas, ya que la ruta en Icy Phoenix 2.0 es distinta a los anteriores versiones de Icy Phoenix. Tambien puede usarse esta Funcion para buscar e reemplazar cualquier Texto en sus temas (Si se deja el campo de busqueda vacio, no se reemplazara Texto alguno y solo las rutas de las imagenes seran ajustadas).',
