...
// Attachments -> Management
  ...
  'Default_quota_limit_explain' => 'Here you are able to select the Default Quota Limit automatically assigned to newly registered Users, and Users without a defined Quota Limit. The Option \'No Quota Limit\' is for not using any Attachment Quotas, instead using the default Settings you have defined within this Management Panel.',
...
// Attachments -> Shadow Attachments
  'Shadow_attachments_explain' => 'Here you can delete attachment data from postings when the files are missing from your file system, and delete files that are no longer attached to any postings. You can download or view a file if you click on it; if no link is present, the file does not exist.',
  ...
  'Shadow_attachments_row_explain' => 'Delete all posting attachment data for files that don\'t exist on your file system.',
...
// Extensions -> Special Categories
  ...
  'Manage_categories_explain' => 'Here you can configure the Special Categories. You can set up Special Parameters and Conditions for the Special Categories assigned to an Extension Group.',
...
// Extensions -> Forbidden Extensions
  ...
  'Manage_forbidden_extensions_explain' => 'Here you can add or delete the forbidden extensions. The Extensions php, php3 and php4 are forbidden by default for security reasons, you cannot delete them.',
...
// Attachments -> Quota Limits
  ...
  'Quota_limit_exist' => 'The Quota Limit %s exists already.', // Replace %s with the Quota Description
...
// Successfully updated
  ...
  'Click_return_attach_config' => 'Kattints %side%s to return to Attachment Configuration',
