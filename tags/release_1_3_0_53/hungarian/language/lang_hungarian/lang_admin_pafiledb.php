...
$lang = array_merge($lang, array (
  ...
  'Rcatexplain' => 'You can re-order categories to change the position they are displayed in on the main page. To re-order the categories, change the numbers to the order you want them shown. 1 will be shown first, 2 will be shown second, etc. This does not affect sub-categories.',
  ...
  'Click_return_catauth' => 'Kattints %side%s to return to Category Permissions',
  'Auth_Control_Category' => 'Category Permissions Control',
  'Category_auth_explain' => 'Here you can alter the authorization levels of each category. Remember that changing the permission level of a category will affect which users can carry out the various operations within them.',
  ...
  'Settingsexplain' => 'The form below will allow you to customize all the general download options.',
  ...
  'File_per_page_info' => 'Here you can set the number of file per page, if you leave it empty the number of per page will be 20.',
  ...
  'Filess_link_info' => 'If you want to show screen shot as link make this as yes.',
  ...
  'Click_return' => 'Kattints %side%s to return to the previous page',
  'Click_return_upload' => 'Click %sHere%s to return to the upload page',
  'Click_edit_permissions' => 'Kattints %side%s to edit the permissions for this category',
