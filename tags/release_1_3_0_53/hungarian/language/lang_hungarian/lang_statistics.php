...
$lang = array_merge($lang, array (
  ...
  'Uses' => 'Uses',
  'How_many' => 'How many',
  'Install_info' => 'Installed on %s',
  'Viewed_info' => 'Statistics Page Loaded %d Times',
  ...
  'Return_limit_desc' => 'The number of items to include in each ranking. This is auto-passed to all modules by being specified here.',
  'Clear_cache' => 'Clear Module Cache',
  'Clear_cache_desc' => 'Clear all the current cached data for all modules',
  'Modules_directory' => 'Modules Directory',
  'Modules_directory_desc' => 'The directory relative to the home phpBB directory where modules are located.  Note that a trailing / or \\ must not be used!',
  ...
  'Update_time_desc' => 'Time Interval (in Minutes) of refreshing the cached data with new Data.',
  'Auto_set_update_time' => 'Determine and set recommended Update Times for every Installed (and Active) Module. Be aware: This may take long.',
  'Uninstall_module' => 'Uninstall Module',
  'Uninstall_module_desc' => 'Marks the module with "not installed" status, so that you may reinstall it with the install command.  It does not delete the module from your file system, you will manually need to delete the module folder to remove it completely.',
  'Active_desc' => 'Option of if the Module is Active, so it is displayed depending on the set Permissions.',
  'Go' => 'Go',
  ...
  'Wrong_stats_mod_version' => 'You are not able to install this Module, because your Statistics Mod Version does not match the Version required by the Module. In order to install and run the Module, you need at least Version %s of the Statistics Mod.',
  'Module_install_error' => 'There was an error of some type installing this module. More than likely some SQL commands could not be executed, check for failure messages above.',
  'Preview_debug_info' => 'This Module was generated in %f seconds: %d queries were executed.',
  'Update_time_recommend' => 'The Statistics Mod recommends (depending on the debug info) a update time of <b>%d</b> Minutes.',
  ...
  'Post_time' => 'Post time',
  'module_name_month_stat' => 'Month Statistics',
  'New_users' => 'New Users',
  ...
  'module_name_users_gender' => 'Genders',
  'Users' => 'Users',
