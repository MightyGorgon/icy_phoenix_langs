...
$faq[] = array("Hur kan man ändra text färg eller storlek", "För att ändra färgen eller storleken på din text kan följande taggar användas. Tänk på att hur produktionen kommer att visas beror på tittarnas webbläsare och system: <ul><li>Ändra färgen på texten uppnås genom omslag i <b>[color=][/color]</b>. Du kan antingen ange en erkänd färg namn (t.ex. red, blue, yellow, etc.) eller hexadecimala triplett alternativ, till exempel. #FFFFFF, #000000. Till exempel, för att skapa röd text kan du använda:<br /><br /><b>[color=red]</b>Hej!<b>[/color]</b><br /><br />or<br /><br /><b>[color=#FF0000]</b>Hej!<b>[/color]</b><br /><br />kommer både att visa <span style=\"color:red\">Hej!</span></li><li>Ändra textstorlek sker på ett liknande sätt använd <b>[size=][/size]</b>. Den här taggen är beroende på mallen som du använder men det rekommenderade formatet är ett numeriskt värde som representerar textstorleken i pixlar, med start vid 1 (så liten att du inte ser det) upp till 29 (mycket stor). Till exempel:<br /><br /><b>[size=9]</b>LITEN<b>[/size]</b><br /><br />kommer i allmänhet att vara <span style=\"font-size:9px\">LITEN</span><br /><br />whereas:<br /><br /><b>[size=24]</b>STOR!<b>[/size]</b><br /><br />kommer att vara <span style=\"font-size:24px\">STOR!</span></li></ul>");
