...
//	'Lang_extend_pack_explain' => 'This is the name of the pack, usualy the name of the MOD refering to',
	...
	'Lang_extend_update_done' => 'Uppgifterna har uppdaterats successfullt.<br /><br />Klicka %sHär%s för att återvända till posten.<br /><br />Klicka %sHär%s för att återvända til post listan',
