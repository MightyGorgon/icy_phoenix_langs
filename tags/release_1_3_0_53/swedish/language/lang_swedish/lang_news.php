...
// News Config
	...
	'News_topic_trim' => '<strong>Nyhets Trim Ämne Längd</strong>',
	...
	'Feed_Language_Explain' => 'Språket kanalen är skrivna i. Du kan använda värden definierade på W3C.',

	'Feed_TTL' => '<strong>Feed TTL (Time To Live)</strong>',
	'Feed_TTL_Explain' => 'TTL är det antal minuter som visar hur länge en kanal kan cacha innan uppfriskande från källan.',
...
// New
	...
	'News_base_url_explain' => 'Placeringen av din nyhets index filen.<br /> i.e. http://mydomain.com/, din nyhets index fil finns här.',
