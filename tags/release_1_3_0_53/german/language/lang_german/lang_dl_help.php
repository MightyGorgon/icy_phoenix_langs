...
*/
	'HELP_Dl_delay_auto_traffic' => 'Gib hier die Anzahl der Tage ein, nach denen ein neuer Benutzer den ersten automatischen Traffic erhält.<br />Der Zeitraum beginnt mit dem Registrierungsdatum.<br />Gib hier 0 ein, um diese Verzögerung zu deaktivieren.',
	'HELP_Dl_delay_post_traffic' => 'Gib hier die Anzahl der Tage ein, nach denen ein neuer Benutzer den ersten Traffic für erstellte Beiträge erhält.<br />Der Zeitraum beginnt mit dem Registrierungsdatum.<br />Gib hier 0 ein, um diese Verzögerung zu deaktivieren.',
	...
	'HELP_Dl_prevent_hotlink' => 'Aktiviere diese Option, wenn du Links zum direkten Download außer aus den Download Details unterbinden willst.<br />Diese Option richtet <b>keinen</b> Verzeichnisschutz ein!',
	...
	'HELP_Dl_show_footer_legend' => 'Diese Option schaltet die Legende mit den Icons für die unterschiedlichen Download Statistik im Fußbereich der Downloads ein oder aus.<br />Die Icons bei den Downloads selber werden dadurch nicht beeinflusst.',
...
*/
	...
	'HELP_Dl_statistics' => 'Schaltet detailierte Statistiken über die Dateien ein.<br />Beachte, dass diese Statistiken zusätzliche Datenbank Abfragen benötigen und Datensätze in einer separaten Tabelle anlegen.',
...
*/
	...
	'HELP_Dl_extern' => 'Aktiviere diese Funktion, wenn du in der obigen Zeile eine URL außerhalb Deines Servers angeben willst (http://www.beispiel.de/media.mp3).<br />Die Funktion "frei" wird dann bedeutungslos.',
	'HELP_Dl_extern_up' => 'Aktiviere diese Funktion, wenn du in dem nachfolgenden Feld eine URL außerhalb deines Servers angeben willst (http://www.beispiel.de/media.mp3).<br />Die Funktion "frei" wird dann bedeutungslos.',
	...
	'HELP_Dl_mod_test' => 'Angabe zur Testumgebung dieses Downloads.<br />Hiermit ist die Forenversion gemeint.<br />Umgesetzt wird dieses als Icy Phoenix X, wobei X hier anzugeben wäre.<br />Diese Angaben werden nur in den Download Details angezeigt.',
	'HELP_Dl_mod_todo' => 'Hier können die nächsten Tätigkeiten an der MOD angegeben werden, die geplant sind oder aktuell anstehen.<br />Aus diesen Angaben wird die ToDo-Liste erstellt, die im Fußbereich der Download aufgerufen werden kann.<br />Mit diesen Angaben kann man anderen Benutzern den Stand der eigenen MODs aufzeigen.<br />Zeilenumbrüche werden hierbei berücksichtigt, BBCodes sind hier nicht verfügbar.<br />Die ToDo-Liste wird auch dann mit diesen Angaben versorgt, wenn der MOD Block nicht aktiviert wurde.',
	...
	'HELP_Dl_user_download_limit_flag' => 'Diese Option lässt dich eine bestimmte Anzahl an Downloads festlegen die jeder Benutzer pro Monat tätigen kann. z.B.: Wenn du diese Funktion aktivierst und "Maximale Anzahl an Downloads pro Monat" auf 30 setzt, kann jeder Benutzer pro Monat maximal 30 Downloads tätigen. Diese Beschränkung gilt nicht für Administratoren und Moderatoren.',
	'HELP_Dl_user_download_limit' => 'Bestimme hier die maximale Anzahl an Downloads die jeder Benutzer tätigen kann pro Monat. Damit dieses Limit wirksam wird muss es mit der Option "Begrenze die Anzahl der Downloads pro Monat" aktiviert werden. Diese Beschränkung gilt nicht für Administratoren und Moderatoren.',
	)
);
