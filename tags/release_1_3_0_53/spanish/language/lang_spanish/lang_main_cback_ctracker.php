...
*/
	'ctracker_error_loading_config' => 'La configuración de CBACK CrackerTracker no puede ser cargada de su base de datos. ¿Se ha asegurado de haber ejecutado el script de instalación y haber editado el archivo "includes/constants.php" correctamente?',
	'ctracker_error_updating_config' => 'La configuración de CBACK CrackerTracker no puede ser actualizada. ¿Se h asegurado de haber ejecutado el script de instalación y haber editado el archivo "includes/constants.php" correctamente?',
	'ctracker_error_loading_blocklist' => 'La configuración de CBACK CrackerTracker no puede ser cargada de su base de datos. ¿Se ha asegurado de haber ejecutado el script de instalación y haber editado el archivo "includes/constants.php" correctamente?',
	'ctracker_error_insert_blocklist' => 'Los datos no se han podido agregar a CBACK CrackerTracker blocklist. ¿Se ha asegurado de haber ejecutado el script de instalación y haber editado el archivo "includes/constants.php" correctamente?',
	'ctracker_error_delete_blocklist' => 'Los datos no se han podido borrar de CBACK CrackerTracker blocklist. ¿Se ha asegurado de haber ejecutado el script de instalación y haber editado el archivo "includes/constants.php" correctamente?',
	'ctracker_error_login_history' => 'Ha habido un error con las operaciones de la base de datos dentro de el historial de identificación de CBACK CrackerTracker. ¿Se ha asegurado de haber ejecutado el script de instalación y haber editado el archivo "includes/constants.php" correctamente?',
...
*/
	...
	'ctracker_info_pw_expired' => 'El administrador ha creado unos ajustes para que su contraseña sea válida solamente por <b>%s días</b>. Se le recomienda que, por razones de seguridad, cambie su contraseña ahora. (<a href="' . PROFILE_MG . '?mode=editprofile&amp;' . POST_USERS_URL . '=%d">Perfil</a>)',
...
*/
	'ctracker_login_title' => 'Activación de cuenta de CrackerTracker',
