...
*
* @package Icy Phoenix
* @version $Id: lang_bots.php 50 2009-07-22 10:13:03Z Mighty Gorgon $
...
$lang = array_merge($lang, array(
	...
	'BOT_EDIT_EXPLAIN' => 'Aquí usted puede añadir o editar una entrada existente del robot. Usted puede definir una cadena de agente y/o una o más direcciones IP (o rangos de direcciones) para jugar. Tenga cuidado al definir las cadenas de agentes o direcciones de IP. También puede especificar un estilo y lenguaje que el robot usará cuando visite el foro. Esto puede hacer reducir el uso de ancho de banda mediante el establecimiento de un estilo sencillo para los robots. Recuerde establecer los permisos adecuados para el grupo especial de robots.',
