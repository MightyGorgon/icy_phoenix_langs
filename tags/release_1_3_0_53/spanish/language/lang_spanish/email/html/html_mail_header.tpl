<html>
	<head>
		...
		<style type="text/css">
			...
			.post-text blockquote { color: #444444; display: block; margin: 5px 20px; width: auto; border: solid 1px #CCCCCC; background: #FFFFFF url({ROOT}templates/common/images/bg_quote_content.gif) bottom right no-repeat; padding: 5px; font-size: 12px; } .post-text blockquote .quote-user, .post-text 
