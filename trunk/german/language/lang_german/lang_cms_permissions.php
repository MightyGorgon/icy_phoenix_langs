...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN' => '
		...
		<h2>Forumbasierte Berechtigungen</h2>
	...
	'ACL_SET_EXPLAIN' => 'Berechtigungen basieren auf einem einfachen <samp>JA</samp>/<samp>NEIN</samp>-System. Wird eine Einstellung für einen Benutzer oder eine Gruppe auf <samp>NIE</samp> gesetzt, so überschreibt dieser Wert alle anderen gesetzten Werte. Wenn du bei diesem Benutzer/dieser Gruppe keinen Wert für eine Einstellung vornehmen möchtest, wähle <samp>NEIN</samp> aus. Wenn an anderer Stelle eine Einstellung vorgenommen wurde, so wird diese verwendet; ansonsten wird von <samp>NIE</samp> ausgegangen. Alle (mit dem davorstehendem Kontrollkästchen) ausgewählten Objekte werden die von dir definierten Berechtigungen übernehmen.',
	'ACL_SETTING' => 'Einstellung',

	'ACL_TYPE_A_' => 'Administrator-Berechtigungen',
	'ACL_TYPE_CMS_' => 'CMS-Berechtigungen',
	'ACL_TYPE_F_' => 'Forum-Berechtigungen',
	'ACL_TYPE_M_' => 'Moderator-Berechtigungen',
	'ACL_TYPE_PL_' => 'Plugin-Berechtigungen',
	'ACL_TYPE_U_' => 'Benutzer-Berechtigungen',

	'ACL_TYPE_GLOBAL_A_' => 'Administrator-Berechtigungen',
	'ACL_TYPE_GLOBAL_CMS_' => 'CMS-Berechtigungen',
	'ACL_TYPE_GLOBAL_M_' => 'Globale Moderator-Berechtigungen',
	'ACL_TYPE_GLOBAL_PL_' => 'Plugin-Berechtigungen',
	'ACL_TYPE_GLOBAL_U_' => 'Benutzer-Berechtigungen',
	'ACL_TYPE_LOCAL_CMS_' => 'CMS-Berechtigungen',
	'ACL_TYPE_LOCAL_CMSL_' => 'CMS-Seiten-Berechtigungen',
	'ACL_TYPE_LOCAL_CMSS_' => 'CMS Standard-Seiten Berechtigungen',
	'ACL_TYPE_LOCAL_CMSB_' => 'CMS-Block-Berechtigungen',
	'ACL_TYPE_LOCAL_F_' => 'Forums-Berechtigungen',
	'ACL_TYPE_LOCAL_M_' => 'Forum Moderator-Berechtigungen',

	'ACL_NO' => 'Nein',
	'ACL_VIEW' => 'Berechtigungen anzeigen',
	...
	'ACP_ADMIN_ROLES' => 'Admin-Rollen',
	'ACP_CMS_ROLES' => 'CMS-Rollen',
	'ACP_FORUM_ROLES' => 'Forum-Rollen',
	'ACP_MOD_ROLES' => 'Moderator-Rollen',
	'ACP_PLUGINS_ROLES' => 'Plugin-Rollen',
	'ACP_USER_ROLES' => 'Globale Rollen',
	...
	'ACP_CMS_ROLES_EXPLAIN' => 'Rollen für CMS-Berechtigungen. Rollen sind zugewiesene Berechtigungen; wenn du eine Rolle änderst, ändern sich die Rechte aller Elemente, denen diese Rolle zugewiesen wurde.',
	...
	'ACP_PLUGINS_ROLES_EXPLAIN' => 'Rollen für Plugin-Berechtigungen. Rollen sind zugewiesene Berechtigungen; wenn du eine Rolle änderst, ändern sich die Rechte aller Elemente, denen diese Rolle zugewiesen wurde.',
	...
	'CREATE_ROLE_FROM' => 'Verwende Einstellungen von&hellip;',
	'CUSTOM' => 'Benutzerdefiniert&hellip;',
	...
	'GROUPS_NOT_ASSIGNED' => 'Dieser Benutzergruppe wurde keine Rolle zugewiesen.',

	'ITEMS_SELECTED' => 'Ausgewählte Artikel',

	'LOOK_UP_GROUP' => 'Benutzergruppe nachschlagen',
	'LOOK_UP_USER' => 'Benutzer suchen',
	'LOOK_UP_CMS_L' => 'Seite auswählen',
	'LOOK_UP_CMS_L_EXPLAIN' => 'Seitenname gefolgt von der Seiten-ID in eckigen Klammern als Referenz',
	'LOOK_UP_CMS_S' => 'Standard-Seite auswählen',
	'LOOK_UP_CMS_S_EXPLAIN' => 'Seitenname gefolgt von der Seiten-ID in eckigen Klammern als Referenz',
	'LOOK_UP_CMS_B' => 'Block auswählen',
	'LOOK_UP_CMS_B_EXPLAIN' => 'Blockname gefolgt von der Seiten-ID in eckigen Klammern als Referenz',

	'MANAGE_GROUPS' => 'Gruppen verwalten',
	'MANAGE_USERS' => 'Benutzer verwalten',

	'NO_AUTH_SETTING_FOUND' => 'Keine definierten Berechtigungen gefunden.',
	'NO_ROLE_ASSIGNED' => 'Keine Rolle zugewiesen&hellip;',
	'NO_ROLE_ASSIGNED_EXPLAIN' => 'Die Auswahl dieser Rolle ändert die rechts angegebenen Rechte nicht. Wenn du alle Berechtigungen entfernen möchtest, verwende den <samp>Alle Nie</samp>-Link.',
	...
	'ROLE_DESCRIPTION_USER_STANDARD' => 'Kann fast alle Benutzer-Funktionen verwenden. Ausgenommen sind z.B. die Änderung des Benutzernamens oder das Übergehen der Wartezeit.',
	...
	'SELECTED_BLOCK_NOT_EXIST' => 'Der/Die ausgewählte(n) Block/Blöcke existieren nicht.',
	'SELECTED_LAYOUT_NOT_EXIST' => 'Die ausgewählte(n) CMS-Seite(n) existieren nicht.',
	'SELECTED_LAYOUT_SPECIAL_NOT_EXIST' => 'Die ausgewählte(n) Standard-Seite(n) existieren nicht.',
	...
	'SELECT_ROLE' => 'Rolle wählen&hellip;',
	'SELECT_TYPE' => 'Berechtigungs-Art',
	'SET_PERMISSIONS' => 'Berechtigungen festlegen',
	'SET_ROLE_PERMISSIONS' => 'Berechtigungen der Rolle festlegen',
	...
	'WRONG_PERMISSION_TYPE' => 'Falschen Berechtigungstyp ausgewählt.',
	'WRONG_PERMISSION_SETTING_FORMAT' => 'Die Berechtigungseinstellungen sind in einem falschen Format, phpBB ist nicht in der Lage, sie richtig zu verarbeiten.',
	)
);
