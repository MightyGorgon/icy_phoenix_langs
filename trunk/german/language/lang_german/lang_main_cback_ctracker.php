...
$lang = array_merge($lang, array(
    ...
    'ctracker_mu_success' => 'Der Benutzer wurde als "Miserable User" markiert und wird ab sofort Probleme beim Surfen auf Deinem Forum haben. ;)',
    'ctracker_mu_success_bbc' => '[cell class="text_orange"]Der Benutzer wurde als "Miserable User" markiert und wird ab sofort Probleme beim Surfen auf Deinem Forum haben. ;)[/cell]',
    'ctracker_mu_success_html' => '<span class="text_orange">Der Benutzer wurde als "Miserable User" markiert und wird ab sofort Probleme beim Surfen auf Deinem Forum haben. ;)</span>',
    ...
    'ctracker_error_updating_userdata' => 'CBACK CrackerTracker konnte die Datenbankoperationen in der Benutzertabelle nicht ausführen.',
    'ctracker_error_database_op' => 'CBACK CrackerTracker konnte die Datenbankoperation nicht korrekt durchführen.',
 ...
 */
    'ctracker_error_loading_config' => 'Die CBACK CrackerTracker Konfiguration konnte nicht von der Datenbank geladen werden. Hast Du das Installationsskript ausgeführt und die Datei "includes/constants.php" korrekt editiert?',
    'ctracker_error_updating_config' => 'Die CBACK CrackerTracker Konfiguration konnte nicht aktualisiert werden. Hast Du das Installationsskript ausgeführt und die Datei "includes/constants.php" korrekt editiert?',
    'ctracker_error_loading_blocklist' => 'Die CBACK CrackerTracker Blockliste konnte nicht von der Datenbank geladen werden. Hast Du das Installationsskript ausgeführt und die Datei "includes/constants.php" korrekt editiert?',
    'ctracker_error_insert_blocklist' => 'Der Datensatz konnte nicht in die CBACK CrackerTracker Blockliste eingefügt werden. Hast Du das Installationsskript ausgeführt und die Datei "includes/constants.php" korrekt editiert?',
    'ctracker_error_delete_blocklist' => 'Der Datensatz konnte nicht von der CBACK CrakerTracker Blockliste entfernt werden. Hast Du das Installationsskript ausgeführt und die Datei "includes/constants.php" korrekt editiert?',
    'ctracker_error_login_history' => 'Es trat ein Fehler bei den Datenbankoperationen innerhalb der CBACK CrackerTracker Login History auf. Hast Du das Installationsskript ausgeführt und die Datei "includes/constants.php" korrekt editiert?',
    'ctracker_error_del_login_history' => 'Die CBACK CrackerTracker Login History Tabelle konnte nicht geleert werden.',
 ...
 */
    ...
    'ctracker_gmb_pu_1' => '<b>CBACK CrackerTracker - Erkennung von Fehlkonfiguration</b><br /><br />Port 21 wird für FTP Dienste verwendet. Wenn das Forum auf diesen Port umgestellt wird, ist es normalerweise nicht mehr lauffähig, da Browser diesen Port ebenfalls als FTP Dienst handhaben.',
    'ctracker_gmb_pu_2' => '<b>CBACK CrackerTracker - Erkennung von Fehlkonfiguration</b><br /><br />Die Sessionlänge ist zu klein eingestellt! Du wirst dadurch möglicherweise ständig aus dem Forum ausgeloggt, bevor Du die Einstellung wieder korrigieren kannst.',
    'ctracker_gmb_pu_3' => '<b>CBACK CrackerTracker - Erkennung von Fehlkonfiguration</b><br /><br />Der Skript Pfad beginnt und/oder endet entweder nicht mit einem Slash (/www/) oder besteht nicht ausschließlich aus dem Slash (/)!',
    'ctracker_gmb_pu_4' => '<b>CBACK CrackerTracker - Erkennung von Fehlkonfiguration</b><br /><br />Der Servername darf nicht mit einem Slash (/) enden!',
