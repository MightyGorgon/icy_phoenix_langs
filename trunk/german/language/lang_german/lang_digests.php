...
// This block goes as default text in the emailed digest (mail_digests.php)
	'digest_introduction' => 'Wie von dir gewünscht, erhältst du hier die letzten Digests der Mitteilungen die bei ' . $config['sitename'] . ' gepostet wurden. Bitte trete der Diskussion bei!',
	...
	'digest_disclaimer_html' => "\n" . 'Dieser Digest wird an registrierte Mitglieder von <a href="' . DIGEST_SITE_URL . '">' . $config['sitename'] . '</a> gesendet und nur weil du es explizit angefordert hast. Deine E-Mail Adresse wird nie an andere Anbieter weitergegeben. Schau in unsere <a href="' . DIGEST_SITE_URL . 'faq.' . PHP_EXT . '">FAQ</a> für mehr Informationen darüber. Du kannst deine Abonnierung bearbeiten oder löschen, indem du Dich unter ' . $config['sitename'] . ' einloggst und die <a href="' . DIGEST_SITE_URL . 'digests.' . PHP_EXT . '">Digest Seite</a> besuchst. (Du musst eingeloggt sein um deine Digest Einstellungen ändern zu können.) Wenn du Fragen oder Hinweise zum Format der Digests hast, sende diese bitte an den <a href="mailto:' . $config['board_email'] . '">' . $config['sitename'] . ' Webmaster</a>.',
	'digest_disclaimer_text' => "\n" . 'Dieser Digest wird an registrierte Mitglieder von ' . $config['sitename'] . ' gesendet und nur weil du es explizit angefordert hast. Deine E-Mail Adresse wird nie an andere Anbieter weitergegeben. Schau in unsere FAQ für mehr Informationen darüber. Du kannst deine Abonnierung bearbeiten oder löschen, indem du Dich unter ' . $config['sitename'] . ' einloggst und die Digest Seite besuchst.. (Du musst eingeloggt sein um deine Digest Einstellungen ändern zu können.) Wenn du Fragen oder Hinweise zum Format der Digests hast, sende diese bitte an den ' . $config['board_email'] . '.',
	'digest_forum' => 'Forum: ',
	'digest_topic' => 'Thema: ',
	'digest_link' => 'Link',
