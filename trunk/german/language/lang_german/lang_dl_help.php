...
*/
    'HELP_Dl_delay_auto_traffic' => 'Gib hier die Anzahl der Tage ein, nach denen ein neuer User den ersten automatischen Traffic erhält.<br />Der Zeitraum beginnt mit dem Registrierungsdatum.<br />Gib hier 0 ein, um diese Verzögerung zu deaktivieren.',
    'HELP_Dl_delay_post_traffic' => 'Gib hier die Anzahl der Tage ein, nach denen ein neuer User den ersten Traffic für erstellte Beiträge erhält.<br />Der Zeitraum beginnt mit dem Registrierungsdatum.<br />Gib hier 0 ein, um diese Verzögerung zu deaktivieren.',
    ...
    'HELP_Dl_thumb_max_dim' => 'Diese Angaben begrenzen die mögliche Bildgrösse der hochgeladener Thumbnails.<br />Gib hier 0 ein, um Thumbnails zu deaktivieren (nicht empfehlenswert, wenn die Thumbnail Dateigröße angegeben wurde).<br />Bestehende Thumbnails werden nach Änderungen dieser Angaben weiterhin angezeigt, sofern nicht die Dateigröße auf 0 gesetzt wurde.',
