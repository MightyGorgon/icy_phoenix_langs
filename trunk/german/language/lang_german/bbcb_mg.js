...
s_url_title_insert = 'Titel des Links eingeben:';
s_url_title_insert_tip = 'Link';
s_url_title_error = 'Du hast keinen Titel eingegeben.';
...
s_img_insert = 'Bild URL eingeben';
s_img_error = 'Du hast keine Bild URL eingegeben.';
s_albumimg_insert = 'Galeriebild ID eingeben';
s_albumimg_insert_tip = 'ID';
s_albumimg_error = 'Du hast keine Galeriebild ID eingegeben.';
s_ram_insert = 'Bitte Real-Media-Datei URL eingeben';
s_stream_insert = 'Bitte Audio-Datei URL eingeben';
...
s_strike_help = 'Durchgestrichen: [strike]Text[/strike]';
s_quote_help = 'Zitat (Quote): [quote]Text[/quote]';
...
s_justify_help = 'Blocksatz: [align=justify]Text[/align]';
s_marqr_help = 'Laufschrift nach rechts: [marquee direction=right]Text[/marquee]';
s_marql_help = 'Laufschrift nach links: [marquee direction=left]Text[/marquee]';
s_marqu_help = 'Laufschrift nach oben: [marquee direction=up]Text[/marquee]';
