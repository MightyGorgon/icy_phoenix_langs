...
$lang = array_merge($lang, array(
	...
	'continue_upgrade' => 'Sobald du deine config.php.php Datei auf dein lokales System runtergeladen hast, kannst du \'Upgrade fortsetzen\' anklicken um mit dem Upgrade weiterzumachen. Bitte warte einen Moment wenn das Upgrade abgeschlossen ist, damit die config.php Datei hochgeladen werden kann.',
	...
	'Inst_Step_2' => 'Dein Admin Benutzername und Passwort wurden erstellt.<br />Um deine Installation abzuschließen musst du die <span class="text_red"> <u>install</u> und <u>contrib</u> Ordner löschen (wenn sie existieren)</span>. Zum Schluss solltest du auf <b>Beende Installation</b> klicken und du wirst ins Admin Control Panel (ACP) und CMS (Content Management System) weitergeleitet, wo du alle Icy Phoenix Einstellungen verwalten kannst.<br />Im ACP kannst du alle Konfigurationen vornehmen, (Styles, Sprachen, Uhrzeit, Foren, Downloads, Benutzer, Album, etc.) und im CMS Bereich kannst du neue Seiten erstellen und konfigurieren (Berechtigungen, Blöcke hinzufügen, neue Seiten erstellen, neue Menüs erstellen, etc.). Du solltest auch die <b>.htaccess</b> und <b>lang_main_settings.php</b> (für jede installierte Sprache extra vorhanden) dir ansehen für Feineinstellungen wie z.B. Fehlerreport, URL Rewrite, Schlüsselwörter, Begrüßungsnachricht, Charset usw.<br /><br />Danke das du dich für IcyPhoenix entschieden hast, aber bitte denke dran deine Datenbank von Zeit zu Zeit zu sichern.<br /><br />',
    ...
    'ColorsLegendGreen' => 'Grün: this action is suggested and can be performed automatically (if requirements are met)',
	...
	'FixAllFiles' => 'Repariere alle Dateien (beide, CMS Seiten und config.php.php)',
	...
	'FixPostedImagesPaths' => 'Reparieren all posted images paths (adjust paths to reflect users subfolders)',

	'FixSignatures' => 'Signaturen reparieren',
	'FixSignaturesExplain' => 'This feature will allow you to Reparieren all users Signaturen. You can use this feature to: find and replace any text in Signaturen, remove all BBCode UID, automatically adjust the address of posted images.',
	'FixingSignaturesInProgress' => 'Reparatur der Signaturen in Bearbeitung',
	'FixingSignaturesFrom' => 'Signaturen modified this step from %s to %s',
	'FixingSignaturesTotal' => '%s signatures of %s modified so far',
	'FixingSignaturesModified' => ' Signaturen repariert',
	'FixingSignaturesComplete' => 'Reparatur signatures complete',
	'SignaturesPerStep' => 'Anzahl der Signaturen pro Schritt',
	'StartFromSignature' => 'Start bei Signatur',

	'FixPics' => 'Reparieren Album Bilder Pfad',
