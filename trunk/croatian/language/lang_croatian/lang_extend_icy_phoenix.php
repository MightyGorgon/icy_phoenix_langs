...
$lang = array_merge($lang, array(
	...
	'20_SQL_Charge' => 'SQL Optimizacija',
	'25_Users' => 'Korisnici',
	'30_Posting' => 'Postovi i Poruke',
	'40_IMG_Posting' => 'Slike u Postovima',
	'50_Hierarchy_setting' => 'Forum',
	'60_Calendar_settings' => 'Kalendar',
	'70_SEO' => 'SEO',
	'80_Security' => 'Logs i Sigurnost',
	'90_Cron' => 'Cron',
	)
);
...
// TAB - Icy Phoenix
		'IP_enable_xs_version_check' => 'Ukljuèi provjeru verzije Icy Phoenix',
		'IP_enable_xs_version_check_explain' => 'Omoguæite ovu opciju da biste provjerili je li noviji Icy Phoenix verzija dostupna je za preuzimanje svaki put kad uðete u ACP. Onemoguæivanje ove opcije moguæe je malo ubrzati ACP uèitavanje.. <br /><b>Napomena:</b> Ova provjera se obavlja samo jednom dnevno, a zatim iz meðuspremnika.',

		'IP_disable_email_error' => 'Iskljuèi greške pri slanju emaila',

		'IP_html_email' => 'HTML Email',
		'IP_html_email_explain' => 'Ukljuèivanjem ove opcije æe omoguæiti HTML e-pošte, u suprotnom æe oni biti jednostavni tekstualni mail',

		'IP_emails_only_to_admins' => 'Email samo Adminima',
		'IP_emails_only_to_admins_explain' => '	Dopusti sustav e-pošte samo za slanje poruka e-pošte da administratorima',

		'IP_ajax_features_title' => 'AJAX Features',

		'IP_ajax_features' => 'Ukljuèi opcije AJAX-a',
		'IP_ajax_features_explain' => '	Neke znaèajke integrirane u AJAX sistemu',

		'IP_ajax_checks_register' => 'AJAX Provjera pri registraciji',
		'IP_ajax_checks_register_explain' => 'Omoguæavanjem ove opcije u nekom realnom vremenu provjere obavljaju se dok je punjenje nekih polja u obrazac za registraciju (Upozorenje: Ova opcija može usporiti prijavnu stranicu).',

		'IP_inactive_users_memberlists' => 'Neaktivni èlanovi u listi Èlanova i Roðendana\' Block',
		'IP_inactive_users_memberlists_explain' => 'Omoguæavanjem ove opcije neaktivni korisnici æe biti prikazani u memberlist i roðendanskom\' bloku.',

		'IP_page_gen' => 'Prikaži vrijeme stvaranja stranice pri dnu',

		'IP_switch_header_dropdown' => 'Ukljuèi padajuèi menu u Headeru',
		'IP_switch_header_dropdown_explain' => 'Ovo æe aktivirati padajuæi izbornik u zaglavlju foruma za pretraživanje i za postove.',

		'IP_show_alpha_bar' => 'Prikaži Alfabetski niz u pregledavanju foruma (Glavni Odabir)',
		'IP_show_alpha_bar_explain' => 'Ova opcija æe prikazati jedan abecedni poredak na vrhu stranice viewforum. You will need also to enable single forums in Forums Management section.',

		'IP_show_rss_forum_icon' => 'Icona na Indeksu Foruma (Glavni Odabir)',
		'IP_show_rss_forum_icon_explain' => 'Ova opcija æe prikazati ikone na lijevoj strani svakog forum (na Forum Index): RSS, Nova Tema. You will need also to enable single forums in Forums Management section.',

		'IP_allow_mods_view_self' => 'Dopusti svim Moderatorima da vide Self Auth Teme',
		'IP_allow_mods_view_self_explain' => 'Ako je forum postavljen na SELF AUTH pristupiti mogu samo Administratori i Moderatori foruma  tim temama kroz viewforum i viewtopic. Meðutim postoje mnoge znaèajke koje mogu prikazati sadržaj ove vrste postova, èak i ako nije na AUTH: Recent Topics, Search, Recent Messages Blocks, Random Topics Blocks, etc. 	Kako bi to sprijeèili, dodatna je opcija koda koja nemože dozvoliti neautorizirane èlanove da pristupe tim temama nekim drugim putem. U svakom sluèaju možete dozvoliti svim Moderatorima (ne samo Adminima) da vide te poruke nekim drugim putem. Ako ste postavili na DA onda æe SVIM Moderatorima biti dozvoljeno da vidite sadržaj tih poruka kroz: Recent, Search, Topics related blocks... Nažalost ako ste to postavili na OFF tada ni AUTHED moderatori nemogu pristupiti SELF AUTHED temama drugim putevima. Znaèajka je kodiran na taj naèin da èuva ekstra SQL punjenje. Ako ne koristite SELF AUTHED forume, tada vam ova funkcija nije potrebna.',

		'IP_xmas_fx' => 'Snijeg',
		'IP_xmas_fx_explain' => 'Ova opcija ukljuèuje efekt snijega.',

		'IP_xmas_gfx' => 'Božiæne Grafike',
		'IP_xmas_gfx_explain' => 'Ukljuèivanjem ove opcije, Božiæne Grafike æe se prikazat.',

		'IP_select_theme' => 'Promijeni Izgled',
		'IP_select_theme_explain' => 'Ukljuèivanjem ove opcije prozorèiæ sa postojeæim izgledima biti æe ukljuèen za brzo mjenjanje izgleda.',

		'IP_select_lang' => 'Promijeni Jezik',
		'IP_select_lang_explain' => 'Ukljuèivanjem ove opcije link sa dostupnim jezicima biti æe na glavnoj strani, za brzo mjenjanje jezika.',

		'IP_cms_dock' => 'Prikaži Apple style Dock u CMS-u',

		'IP_cms_style' => 'Moderan Izgled CMS-a',
		'IP_cms_style_explain' => 'Moderan izgled CMS-a je u modernom izgledu sa prozirnim menijem na vrhu, dok klasièni izgled ima meni sa strane',

		'IP_split_ga_ann_sticky' => 'Podijeli Teme po vrsti',
		'IP_split_ga_ann_sticky_explain' => 'Ovdje možete odabrati naèin podjele Tema po vrsti na viewforum starni',
		'IP_split_topic_0' => '<p>Sve vrste Tema zajedno (Nepodjeljeno)</p>',
		'IP_split_topic_1' => '<p>Globalne Obavjesti, Obavjesti i Važne zajedno, Normalne Teme podjeljene</p>',
		'IP_split_topic_2' => '<p>Globalne Obavjesti podjeljene, Obavjesti i Važne povezane, Normalne Teme podjeljene</p>',
		'IP_split_topic_3' => '<p>Sve vrste Tema podjeljene</p>',

// TAB - SQL Charge
		'IP_fast_n_furious' => 'Brzo i Žestoko',
		'IP_fast_n_furious_explain' => 'Omoguèavanjem ove opcije neke teže SQL funkcije biti æe iskljuèene, to æe omoguèiti brži rad vaše Stranice!',
		...
		*/
		...
		'IP_site_history' => 'Povijest Stranice',
		'IP_site_history_explain' => 'Ukljuèivanjem ove opcije ukljuèujete Povijest Stranice.',
		...
		'IP_show_forums_online_users' => 'Prikaži korisnike online u forumima',
		'IP_show_forums_online_users_explain' => 'Ova opcija ukljuèuje broj online korisnika for za svaki forum na index-u.',

		'IP_google_bot_detector' => 'Ukljuèi GoogleBot Detektor',

		'IP_gsearch_guests' => 'Prisili Google Search za goste',

		'IP_visit_counter_switch' => 'Ukljuèi Brojaè Posjeta',

		'IP_enable_new_messages_number' => 'Prikaži broj novih poruka od zadnje posjete',

		'IP_disable_thanks_topics' => 'Iskljuèi Hvala (Globalno)',

		'IP_show_thanks_profile' => 'Pokaži dobivenih Hvala u profilu',

		'IP_show_thanks_viewtopic' => 'Pokaži dobivenih Hvala kod pregledavanja Tema',
		...
		'IP_disable_referrers_explain' => 'Ova opcija vam omoguèuje iskljuèivanje Referrers (ovo štedi SQL prostor).',
