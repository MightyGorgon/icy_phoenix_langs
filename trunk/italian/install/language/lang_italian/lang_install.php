...
$lang = array_merge($lang, array(
	...
	'FixBirthdays' => 'Correggi Compleanni (Aggiornando da Icy Phoenix 1.2 o inferiore)',
	'FixBirthdaysExplain' => 'Questa funzione serve per correggere il formato dei compleanni. Non hai bisogno di usare questa funzione se stai aggiornando da Icy Phoenix 1.3 o superiore.',
	...
	'FixConstantsInFiles' => 'Aggiornamento nuove costanti (Aggiornando da Icy Phoenix 1.2 o inferiore)',
	'FixConstantsInFilesExplain' => 'Aggiornamento delle nuove costanti nei files del CMS. Non hai bisogno di usare questa funzione se stai aggiornando da Icy Phoenix 1.3 o superiore.',
	...
	'FixForums' => 'Converti Forum (Aggiornando da Icy Phoenix 1.2 o inferiore)',
	'FixForumsExplain' => 'Questa funzione convertir&agrave; forum e categorie nel nuovo formato. Non hai bisogno di usare questa funzione se stai aggiornando da Icy Phoenix 1.3 o superiore.',
	'FixingForumsInProgress' => 'Conversione in corso...',
	'FixingForumsComplete' => 'Conversione completata!',

	'FixPosts' => 'Correggi Messaggi (Aggiornando da Icy Phoenix 1.2 o inferiore)',
	'FixPosts_Explain' => 'Questa funzione serve per correggere i messaggi del forum. Si pu&ograve; utilizzare per: sostituire del testo all\'interno dei messaggi, eliminare il BBCode UID, modificare l\'indirizzo delle immagini inviate. Non hai bisogno di usare questa funzione se stai aggiornando da Icy Phoenix 1.3 o superiore.',
	'FixPosts_IP2' => 'Correggi Messaggi (Aggiornando da Icy Phoenix 1.3 o superiore)',
	'FixPosts_IP2_Explain' => 'Questa funzione serve per correggere i percorsi errati delle immagini caricate nei messaggi del forum. Si pu&ograve; utilizzare la funzione anche per sostituire del testo all\'interno dei messaggi. Lasciando vuoto il campo di ricerca, verr&agrave; corretto solo il percorso delle immagini.',
	...
	'FixSignatures' => 'Correggi Firme (Aggiornando da Icy Phoenix 1.2 o inferiore)',
	'FixSignatures_Explain' => 'Questa funzione serve per correggere le firme degli utenti. Si pu&ograve; utilizzare per: sostituire del testo all\'interno delle firme, eliminare il BBCode UID, modificare l\'indirizzo delle immagini inviate. Non hai bisogno di usare questa funzione se stai aggiornando da Icy Phoenix 1.3 o superiore.',
	'FixSignatures_IP2' => 'Correggi Firme (Aggiornando da Icy Phoenix 1.3 o superiore)',
	'FixSignatures_IP2_Explain' => 'Questa funzione serve per correggere i percorsi errati delle immagini caricate nelle firme degli utenti. Si pu&ograve; utilizzare la funzione anche per sostituire del testo all\'interno delle firme. Lasciando vuoto il campo di ricerca, verr&agrave; corretto solo il percorso delle immagini.',
	...
	'FixPics' => 'Correggi Immagini Album (Aggiornando da Icy Phoenix 1.2 o inferiore)',
	'FixPicsExplain' => 'Questa funzione serve per spostare le immagini dell\'album nelle sottocartelle degli utenti e aggiornare il database con i nuovi percorsi. Non hai bisogno di usare questa funzione se stai aggiornando da Icy Phoenix 1.3 o superiore.',
	...
	'RenMovePics' => 'Rinomina E Sposta Immagini Inviate (Aggiornando da Icy Phoenix 1.2 o inferiore)',
	'RenMovePicsExplain' => 'Questa funzione rinomina e sposta tutte le immagini inviate dagli utenti che si trovano nella cartella principale muovendole in sottocartelle per utente: se lanci questa applicazione avrai bisogno poi di modificare tutti i messaggi tramite la funzione <i>Correggi Messaggi</i>. Non hai bisogno di usare questa funzione se stai aggiornando da Icy Phoenix 1.3 o superiore.',

	'AddPostedPicsDB' => 'Importa Immagini Nel DB (Aggiornando da Icy Phoenix 1.3 o superiore)',
	'AddPostedPicsDBExplain' => 'Questa funzione consente di importare le immagini caricate dagli utenti nel DB.',
