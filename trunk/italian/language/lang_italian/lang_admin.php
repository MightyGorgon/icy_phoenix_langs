...
// Custom BBCodes - END
	...
	'UPE_USER_IDS_JQ' => 'Ricerca Utente',
	'UPE_USER_IDS_JQ_EXPLAIN' => 'La ricerca degli utenti &egrave; in ajax, iniziando a digitare il nome utente, verr&agrave; mostrata la lista degli utenti corrispondenti nella colonna di sinistra sottostante: sar&agrave; possibile spostare nella colonna di destra gli utenti da selezionare (attraverso drag and drop con il mouse).',
	'UPE_USER_IDS_JQ_LIST' => 'Lista Utenti',
	'UPE_USER_IDS_JQ_LIST_EXPLAIN' => 'Scrivendo anche parzialmente nella casella RICERCA UTENTE il nome degli utenti la colonna di sinistra si popoler&agrave; con gli utenti trovati. Spostando gli utenti nella colonna di destra, questi verranno selezionati per l\'esportazione dei messaggi. La colonna di sinistra contiene i risultati della ricerca degli utenti, mentre la colonna di destra contiene gli utenti selezionati.',
	'UPE_PROCESSING' => 'Esportazione corso... per favore non chiudere il browser!',
	'UPE_PROCESSING_CURRENT_LOOP' => 'Elaborazione:',
	'UPE_NO_USER' => 'Nessun Utente',
	'UPE_EXPORT_COMPLETE' => 'Esportazione Completata!',
	'UPE_LIMIT' => 'Limite Messaggi Per Ciclo',
	'UPE_LIMIT_EXPLAIN' => 'Numero massimo di messaggi esportato per ciascun ciclo',
	'UPE_POSTS_TYPE' => 'Tipo Messaggi',
	'UPE_POSTS_TYPE_EXPLAIN' => 'Esportazione di tutti i messaggi o soltanto degli argomenti iniziati',
	'UPE_POSTS_TYPE_TOPICS' => 'Solo Argomenti',
	'UPE_POSTS_TYPE_ALL' => 'Tutti I Messaggi',
	'UPE_IN_PROGRESS_REDIRECT' => 'Verrai automaticamente reindirizzato al passo successivo in tre secondi',
	'UPE_IN_PROGRESS_REDIRECT_CLICK' => 'Se il reindirizzamento automatico non dovesse funzionare, puoi cliccare %sQUI%s',
	'UPE_COMPLETE_REDIRECT_CLICK' => 'Clicca %sQUI%s per tornare alla Esportazione Messaggi',
	'UPE_FILES_LIST' => 'Esportazione Messaggi - Archivio',
	'UPE_FILES_LIST_SELECT' => 'Seleziona un file',
	'UPE_FILES_LIST_SELECT_EXPLAIN' => 'Puoi selezionare un file e scaricarlo o cancellarlo',
	'UPE_FILES_LIST_DOWNLOAD' => 'Scarica',
	'UPE_FILES_LIST_DELETE' => 'Elimina',
	'UPE_FILES_LIST_DELETE_SELECTED' => 'Sei sicuro di voler eliminare il file selezionato?',
	'UPE_FILES_LIST_DELETED' => 'Il file selezionato &egrave; stato eliminato correttamente',
	'UPE_FILES_LIST_INVALID' => 'File non valido',
