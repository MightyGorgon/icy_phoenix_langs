...
$lang = array_merge($lang, array (
  ...
  'Click_return_categoryadmin' => 'Kattints %side%s a kategória adminisztrálásához való visszatéréshez',
  'Click_return_dl_config' => 'Kattints %side%s letöltés konfigurálásához való visszatéréshez',
  'Click_return_downloadadmin' => 'Kattints %side%s letöltések adminisztrálásához való visszatéréshez',
  'Click_return_downloads' => 'Kattints %side%s Letöltéskategóriákhoz való visszatéréshez',
  'Click_return_download_details' => 'Kattints %side%s letöltéshez való visszatéréshez',
  'Click_return_file_management' => 'Kattints %side%s a fájlkezeléshez való visszatéréshez',
  'Click_return_modcp_approve' => 'Kattints %side%s a jóváhagyatlan letöltésekhez való visszatéréshez',
  'Click_return_modcp_manage' => 'Kattints %side%s a moderátorpanelhez való visszatéréshez',
  'Click_return_user_traffic_admin' => 'Kattints %side%s más felhasználó forgalmának beállításához',
  'Click_return_usergroup_traffic_admin' => 'Kattints %side%s más felhasználócsoport forgalmának beállításához',
  ...
  'Dl_user_config_saved' => 'A letöltések felhasználói beállítása sikeresen frissítve<br /><br />Kattints %side%s a letöltésekhez való visszatéréshez',
  'Download_added' => 'A letöltés hozzáadva',
  'Download_removed' => 'A letöltés törölve',
  'Download_updated' => 'Az információk frissítve',
  'New_download' => 'Az új letöltés feltöltve vagy frissítve.<br />Kattints %side%s a letöltésekhez való ugráshoz.',
  ...
  'Dl_must_be_approve_comment' => 'Ezt a kommentárt muszály egy muderátornak vagy egy adminisztrátornak elfogadni!',
  'Dl_approve_overview_one_comment' => 'Itt egy nem elfogadott kommentár van. Kattints a szövegre az elenõrzéshez.',
