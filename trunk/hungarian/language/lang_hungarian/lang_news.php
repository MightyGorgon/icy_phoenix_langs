...
$lang = array_merge($lang, array (
  'Regular_Post' => 'Általános hozzászólás (Nincs a híreknél megjelenítva)',
  'Current_Selection' => 'Jelenlegi rész',
  'Select_News_Category' => 'Hírkategória kiválasztása',
  'News' => 'Hírek',
  'News_Cmx' => '<b>Hírek:</b>&nbsp;',
  'Auth_News' => 'Hírek',
  ...
  'News_Explain' => 'From this page you can add, remove and edit the news categories.',
  'Enable_News' => '<strong>Enable news posting</strong>',
  'News_Path' => '<strong>News icons path</strong>',
  'News_Path_Explain' => 'Path under your phpBB root dir, e.g. images/news',
  ...
  'News_base_url_explain' => 'A hírek index fájljának a helye.<br /> pl. http://mydomain.com/, ha a híreid index fájlja itt található.',
  'Show_RSS_abstract' => '<strong>Mutasd az RSS Feedek meghatározását.</strong>',
  'News_index_file' => '<strong>News Mod Index Fájl</strong>',
  'News_index_file_explain' => 'A hírek index fájljának a neve. pl. news_index.php.',
))
?>