...
$lang = array_merge($lang, array (
  ...
  'Click_return_kb' => 'Kattints %side%s a Tudásbázis való visszatéréshez',
  'Click_return_article' => 'Kattints %side%s a Cikk való visszatéréshez',
  ...
  'Approve' => 'Elfogad',
  'Un_approve' => 'Visszavon',
  'Article_approved' => 'A cikk el van fogadva.',
  ...
  'Click_return_article_manager' => 'Kattints %side%s a Cikkezelõköz való visszatéréshez',
...
',
  ...
  'KB_Rules_moderate' => 'You <b>can</b> %smoderate this category%s',
  'KB_Rules_moderate_can' => 'You <b>can</b> moderate this category',
  ...
  'Post_comments' => 'Kommentek beküldése',
  ...
  'News_updated_return_settings' => 'KB block configuration updated successfully.<br /><br />Kattints %side%s to return to main page.',
  ...
  'Wysiwyg_path_explain' => 'This is the path (from mxBB/phpBB root) to the wysiwyg software folder, eg \'modules/\' if you have uploaded for example tinemce in modules/tinymce.',
