...
$lang = array_merge($lang, array (
  ...
  'xs_main_comment3' => 'All functions of phpBB styles management are replaced with eXtreme Styles mod.<br /><br /><a href="{URL}">Click here</a> to see menu.',
  ...
  'xs_configuration_explain' => 'This feature allows you to change the eXtreme Styles configuration.',
  'xs_default_style' => 'Default Style',
  'xs_default_style_explain' => 'This feature allows you to change the default forum style and switch users from one style to another.',
  'xs_manage_cache' => 'Manage Cache',
  'xs_manage_cache_explain' => 'This feature allows you to manage cached files.',
  'xs_import_styles' => 'Import Styles',
  'xs_import_styles_explain' => 'This feature allows you to download and install .style files.',
  'xs_export_styles' => 'Export Styles',
  'xs_export_styles_explain' => 'This feature allows you to save a style from your forum as a .style file and then easily transfer it to another forum or another website.',
  'xs_clone_styles' => 'Clone Styles',
  'xs_clone_styles_explain' => 'This feature allows you to quickly clone styles or a whole template.',
  'xs_download_styles' => 'Download Styles',
  'xs_download_styles_explain' => 'This feature allows you to quickly download and install styles from websites. You can configure a list of websites yourself.',
  'xs_install_styles' => 'Install Styles',
  'xs_install_styles_explain' => 'This feature allows you to install styles that are already uploaded to your forum.',
  'xs_uninstall_styles' => 'Uninstall Styles',
  'xs_uninstall_styles_explain' => 'This feature allows you to remove styles from your forum.',
  'xs_edit_templates_explain' => 'This feature allows you to edit tpl files online.',
  'xs_edit_styles_data' => 'Edit Styles Data',
  'xs_edit_styles_data_explain' => 'This feature allows you to edit style variables. It is used by some styles, but most styles don\'t use it and use a css file instead.',
  'xs_export_styles_data' => 'Export Styles Data',
  'xs_export_styles_data_explain' => 'This feature allows you to save style variables to theme_info.cfg.',
  'xs_check_for_updates' => 'Check for Updates',
  'xs_check_for_updates_explain' => 'This feature allows you to check for updated versions of styles and mods installed on your forum.',
  ...
  'xs_ftp_error_nonphpbbdir' => 'FTP error: you have set invalid directory. There are no phpBB files in that directory',
  ...
  'xs_config_subtitle' => 'This is the configuration for eXtreme Styles. If you don\'t understand what certain variables do then don\'t change it.',
  ...
  'xs_config_show_error_explain' => 'This feature enables/disables errors in tpl files that the user used incorrectly &lt;!-- INCLUDE filename --&gt;',
  ...
  'xs_config_use_cache_explain' => 'Cache is saved to disk and it will accelerate templates system because there would be no need to compile template every time it is shown.',
  'xs_config_auto_compile' => 'Automatically save cache',
  'xs_config_auto_compile_explain' => 'This will automatically compile templates that are not cached and save to cache directory.',
  ...
  'xs_config_php_explain' => 'This is extension of cached files. Files are stored in php format so default extension is "php". Do not include dot',
  ...
  'xs_cache_confirm' => 'If you have many styles it might cause huge server load. Are you sure you want to continue?',
  ...
  'xs_import_explain' => 'This feature allows you to import styles. It can also automatically install and update styles.<br /><br />Note: If you have added any mods (except for eXtreme Styles mod) on this forum then you should be careful when importing styles because styles might not be compatible with your forum. You can only install styles that have the same modifications as the other styles that you\'ve configured on your forums.',
  'xs_import_lc' => 'import',
  ...
  'xs_download_explain2' => 'This feature allows you to quickly download and install styles directly from different websites. Click on the link near the website name and you will be redirected to a style downloads page.<br /><br />You can also manage the list of websites.',
  ...
  'xs_import_tpl_comment' => 'This feature will upload template to your forum. If template with this name already exists on your forum this feature will automatically overwrite old files so it can also be used to update styles.<br /><br />This feature can also automatically install styles. If you want to install style after importing it then select one or more styles below.',
  ...
  'xs_clone_style_explain' => 'This feature allows you to quickly clone style or whole template.<br /><br />Warning: If you are copying template make sure author of original template allows you to do this (unless it is subSilver - you can do whatever you want with subSilver). Usually authors allow to modify their styles, but modified style should not be distributed.',
  'xs_clone_style_explain2' => 'This feature allows you to create new style for a template. This feature will not copy any files - it will add entry in database for your new style. Both old and new style will share same templates.',
  'xs_clone_style_explain3' => 'Enter name for new style that you are going to create and click "clone" button.',
  'xs_clone_style_explain4' => 'This feature allows you to clone template. You can also copy all styles associated with that template. Later you can safely edit tpl files for new template and old template will not be affected.',
  ...
  'xs_uninstall_styles_explain2' => 'This is a list of styles that are installed on your forum. Click on the "uninstall" link to remove some styles from the forum. Uninstalling is safe - all users who employ the style that is being uninstalled will be switched to the default forum style. Also, uninstalling will automatically delete cache for that style.',
  'xs_install' => 'Install',
  ...
  'xs_uninstall_default' => 'You cannot remove default style. To change default style <a href="{URL}">click here</a>.',
  ...
  'xs_edit_template_comment1' => 'This feature allows you to edit templates. File browser shows only editable files.',
  'xs_edit_template_comment2' => 'This feature allows you to edit templates.',
