...
$lang = array_merge($lang, array (
  'Album_config' => 'Album',
  'Album_config_explain' => 'You can change the Photo Album settings here.<br />',
  'Album_config_updated' => 'Album Configuration has been updated successfully',
  'Click_return_album_config' => 'Kattints %side%s to return to the Album Configuration',
  ...
  'Quick_Thumbnails_explain' => 'Enabling this option the system will check if thumbnails have already been generated and try to send them directly to the browser. This will speed up thumbnails generation when viewing cats.',
  ...
  'Set_Memory_Explain' => 'This feature may be used to increase memory limit in PHP (this setting must be allowed by your hosting): you can try to increase memory when your images are not loaded correctly. To avoid higher memory limits the max value is forced to be 16MB.',
  ...
  'Album_Personal_Auth_Explain' => 'Here you can choose which usergroup(s) can be the moderators for <b>all</b> personal album categories or just has the private access to them',
  ...
  'Click_return_album_personal' => 'Kattints %side%s to return to the Personal Gallery Settings',
  ...
  'Click_return_personal_gallery_index' => 'Kattints %side%s to return to the personal gallery index',
  ...
  'Click_return_album_category' => 'Kattints %side%s to return to the Album Categories Manager',
  ...
  'Watermark' => 'WaterMark',
  'Watermark_explain' => 'You can specify the watermark file to be used in this category. Insert the watermark file path respect to your phpBB root (i.e.: <b>album_mod/mark_fap.png</b>). The watermark will be applied only if Watermark feature is on.',
  ...
  'Click_return_album_auth' => 'Kattints %side%s to return to the Album Permissions',
  'Upload' => 'Upload',
  'Rate' => 'Rate',
  'Comment' => 'Comment',
  ...
  'SP_Album_config_explain' => 'Here you can configure some options for the Album Service Pack',
  ...
  'path_to_bin' => 'Path from phpBB root to cgi-bin (i.e. <b>./cgi-bin/</b> if you have phpBB in a sub folder)',
