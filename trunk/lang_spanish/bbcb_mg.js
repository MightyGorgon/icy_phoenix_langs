s_formerrors = 'Debe escribir algún texto para enviar un mensaje';
s_gen_error = ':: Error ::\n\n';
s_url_insert = 'Inserte la URL (por ejemplo, http://www.phpbb.com/)';
s_url_insert_tip = 'http://';
s_url_error = 'No ha introducido ninguna URL';
s_url_title_insert = 'Escriba el título para el enlace';
s_url_title_insert_tip = 'Enlace';
s_url_title_error = 'No ha escrito el nombre de la página';
s_email_insert = 'Escriba la dirección de correo';
s_email_insert_tip = 'sunombre@sudominio.com';
s_email_error = 'No ha escrito la dirección de correo';
s_img_insert = 'Escriba la URL de la imagen';
s_img_error = 'No ha escrito la URL de la imagen';
s_albumimg_insert = 'Escriba la ID de la imagen del álbum';
s_albumimg_insert_tip = 'ID';
s_albumimg_error = 'No ha escrito la ID de la imagen del álbum';
s_ram_insert = 'Por favor, escriba la URL del archivo real media';
s_stream_insert = 'Por favor, escriba la URL del archivo de audio';
s_video_insert = 'Por favor, escriba la URL del archivo de vídeo';
s_video_w_insert = 'Por favor, especifique la anchura del vídeo';
s_video_w_error = 'No ha especificado la anchura del vídeo';
s_video_h_insert = 'Por favor, especifique la altura del vídeo';
s_video_h_error = 'No ha especificado la altura del vídeo';
s_googlevideo_insert = 'Por favor, escriba la ID del archivo de Google vídeo';
s_youtube_insert = 'Por favor, escriba la ID del archivo de YouTube';
s_emff_insert = 'Por favor, escriba la URL del archivo mp3';
s_flash_insert = 'Por favor, escriba la URL de la película flash';
s_flash_w_insert = 'Por favor, escriba la anchura de la película flash';
s_flash_w_error = 'No ha especificado la anchura de la película flash';
s_flash_h_insert = 'Por favor, escriba la altura de la película flash';
s_flash_h_error = 'No ha especificado la altura de la película flash';
s_id_insert_tip = 'ID';
s_id_insert_error = 'No ha especificado ninguna ID';
s_file_insert_error = 'No ha especificado la URL del archivo';
s_grad_select = 'Por favor, seleccione primero el texto';
s_grad_error = 'Esta opción sólo trabaja con menos de 120 letras';
s_grad_path = 'includes/grad.htm';
s_view_more_code = 'Ver más código';
s_image_upload = 'Subir una imagen a PostImage.org y añadir al mensaje';
s_posticyimage = 'Subir una imagen y añadirla al mensaje';
...
s_img_help = 'Insertar imagen: [img]http://imagen_url[/img]';
...
s_albumimg_help = 'Insertar imagen del álbum: [albumimg]ID imagen álbum[/albumimg]';
s_albumimgl_help = 'Insertar imagen desde el álbum alineada a la izquierda: [albumimg align=left]ID de la imagen del álbum[/albumimg]';
s_albumimgr_help = 'Insertar imagen desde el álbum alineada a la derecha: [albumimg align=right]ID de la imagen del álbum[/albumimg]';

s_url_help = 'Insertar URL: [url]http://url[/url] o [url=http://url]Texto URL[/url]';
s_fc_help = 'Color de fuente: [color=red]texto[/color] (Nota: puede usar color=#FF0000)';
s_fs_help = 'Tamaño de fuente: [size=9]texto[/size]';
...
s_mail_help = 'Insertar correo: [email]correo aquí[/email]';
s_grad_help = 'Insertar texto multicolor';
s_right_help = 'Alinear texto alineado a la derecha: [align=right]texto[/align]';
s_left_help = 'Alineas texto alineado a la izquierda: [align=left]texto[/align]';
s_center_help = 'Centrar texto alineado al centro: [align=center]texto[/align]';
...
s_hr_help = 'Insertar línea horizontal [hr]';
s_bullet_help = 'Insertar punto [*]';
s_video_help = 'Insertar archivo de vídeo: [video width=# height=#]URL archivo[/video]';
s_googlevideo_help = 'Introduzca un archivo de Google vídeo: [googlevideo]ID Google vídeo[/googlevideo]';
s_youtube_help = 'Introduzca un archivo de YouTube: [youtube]ID YouTube[/youtube]';
s_quick_help = 'QuickTime vídeo: [quick]http://quicktime_video_url/[/quick]';
s_flash_help = 'Insertar película flash: [flash width=# height=#]URL flash[/flash]';
s_ram_help = 'Introduzca un archivo real media: [ram]URL archivo[/ram]';
s_stream_help = 'Introduzca un archivo stream: [stream]URL archivo[/stream]';
s_emff_help = 'Introduzca un archivo mp3: [emff]URL archivo[/emff]';
s_fade_help = 'Decolorar (Fade): [opacity]texto[/opacity] o [opacity][img]http://image_url/[/img][/opacity]';
s_spoiler_help = 'Spoiler: [spoiler]texto[/spoiler]';
s_cell_help = 'Celda: [cell]texto[/cell]';
s_list_help = 'Lista ordenada: [list|=1|a]texto[/list] (Nota: puede usar [*] para insertar un punto)';
s_listo_help = 'Lista ordenada: [list=1|a]texto[/list] (Nota: puede usar [*] para insertar un punto)';
s_help_help = 'Abrir ayuda de BBCode';
s_image_upload_help = 'Subir imagen a PostImage.org y añadir al mensaje';
s_posticyimage_help = 'Subir imagen y añadirla al mensaje';
s_smiley_creator = 'Personalizar emoticono: [smiley=1]Texto[/smiley] insertar un emoticono con texto';
