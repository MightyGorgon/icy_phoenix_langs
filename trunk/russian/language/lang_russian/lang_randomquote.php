...
$randomquote = array(
	...
	'Те, кто не ничего неделают никогда не ошибаются.  (Theodore de Banville (French Poet))',
	'Doubt не приятное состояние духа, но уверенности, является абсурдным.  (Voltaire (French Writer and Philosopher))',
	'Если мы должны простить врага, мы не обязаны ему верить.  (Thomas Fuller (British author/clergyman)',
);
