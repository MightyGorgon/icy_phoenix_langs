...
$mtnc[] = array('statistic',
	'Статистика ',
	'Показывает информацию о форуме и базой данных. ',
	'',
	0);
$mtnc[] = array('config',
	'Конфигурация ',
	'Позволяет конфигурации DB обслуживание .',
	'',
	5);
$mtnc[] = array('--', '', '', '', 0);
$mtnc[] = array('check_user',
	'Проверить пользователей и групп таблицы ',
	'Это позволит проверить пользователя и группу таблиц на наличие ошибок и восстановить отсутствующие одной группы пользователей. ',
	'Вы потеряете все без какой-либо член этой акцией. Продолжить? ',
	0);
