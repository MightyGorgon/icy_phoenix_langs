...
// MG CMS - BEGIN
    ...
    'Click_return_bpadmin' => 'Klick %sHier%s um zur Block Positions Administration zurückzukehren',
    ...
    'Blocks_Explain' => 'Von diesem Control Panel aus kannst du Blocks für jede verfügbare Site Page hinzufügen, bearbeiten, löschen und verschieben. Für jede hinzugefügte Block Datei muss ein Block Template vorhanden sein.',
    'Blocks_Duplicate_Explain' => 'Von diesem Control Panel aus kannst du Blöcke von anderen Layouts duplizieren. Nur Blöcke die mit dem ausgewählten Layout kompatibel sind werden angezeigt. Um Blöcke zu duplizieren musst du nur die Box, für jeden Block den du hinzufügen willst, ankreuzen und dann nur noch "Blöcke duplizieren" am Seitenende anklicken.',
    ...
    'Block_updated' => 'Block aktualisiert',
    'Blocks_updated' => 'Blöcke aktualisiert',
    'Must_enter_block' => 'Du musst einen Block Titel eingeben',
    'Block_added' => 'Block hinzugefügt',
    'Blocks_added' => 'Blöcke hinzugefügt',
    'Blocks_duplicated' => 'Blöcke dupliziert',
    'Click_return_blocksadmin' => 'Klicke %shier%s, um zum Block Management zurückzukehren',
    'Block_removed' => 'Block gelöscht',
    'B_BV_added' => 'Block Config Datei verfügbar: Block Variablen automatisch eingefügt',

    'BV_Title' => 'Block Variablen',
    'BV_Explain' => 'Von diesem Control Panel aus kannst du die Block Variablen die auf den Site Pages verwendet werden, hinzufügen, bearbeiten und löschen. Diese Variablen können dann durch die Home Page Konfigurations Seite eingestellt werden um dein Portal zu personalisieren.',
    'BV_Label' => 'Feld Label',
    ...
    'No_bv_selected' => 'Keine Block Variable zum konfigurieren, klicke auf SUBMIT/SENDEN um diesen Block zu speichern.',
    'BV_Edit_Variable' => 'Bearbeite Block Variable',
    'Must_enter_bv' => 'Du musst ein Feld Label und ein Config Name angeben',
    'BV_updated' => 'Block Variable aktualisiert',
    'BV_added' => 'Block Variable hinzufügt',
    ...
    'BV_removed' => 'Block Variable entfernt',
    ...
    'Portal_Explain' => 'Von diesem Control Panel aus, kannst du alle Konfigurationen die für deine Site Pages benötigt werden, einstellen. Block Variablen die auf dieser Seite gelistet sind, können auf der Block Variablen Config Seite erstellt/aktualisiert werden',
    ...
    'Confirm_delete_item' => 'Bist du sicher das du diesen Artikel löschen willst?',
    'Cache_cleared' => 'Cache Dateien gelöscht',
...
//    'cms_pos_' => '',
    ...
    'cms_block_dyn_menu' => 'Dynamisches Menue',
    ...
    'cms_block_sec_menu' => 'Extra Menue',
...
//    'cms_var_' => '',
    ...
    'CMS_Filename_Explain' => '<i>(Um eine neue Datei zu erstellen muß dein Server richtig konfiguriert sein. Sonst wird dieses Feature nicht unterstützt.)</i>',
...
// MG CMS MENU - BEGIN
    ...
    'CMS_Menu_New_menu_des' => 'Menue-Beschreibung',
    ...
    'Click_Return_CMS_Menu' => 'Klicke %shier%s, um zur Menue-Administration zurückzukehren',

    'Menu_created' => 'Menue wurde erfolgreich erstellt.',
    'Cat_created' => 'Kategorie erfolgreich erstellt.',
    'Link_created' => 'Link erfolgreich erstellt.',
    'Menu_updated' => 'Menue erfolgreich aktualisiert.',
    'Cat_updated' => 'Kategorie erfolgreich aktualisiert.',
    'Link_updated' => 'Link erfolgreich aktualisiert.',
    'Menu_deleted' => 'Menue erfolgreich gelöscht.',
    'Cat_deleted' => 'Kategorie erfolgreich entfernt.',
    'Link_deleted' => 'Link erfolgreich entfernt.',

    'CMS_Menu_Not_Exist' => 'Dieses Menue existiert nicht.',
    'CMS_Menu_Items_Not_Exist' => 'Dieses Menue hat keine Kategorie. Klicke auf hinzufügen, um eine zu erstellen.',
    'CMS_Menu_No_Cats_Exist' => 'Dieser Menue-Block hat keine Kategorie. Bevor du einen Link erstellen kannst, mußt du eine Kategorie anlegen.',
    'CMS_Menu_Item_Not_Exist' => 'Dieser Menue-Eintrag existiert nicht.',
    'CMS_Menu_Item_Add_Edit' => 'Menue-Eintrag hinzufügen/bearbeiten.',
// MG CMS MENU - END
...
// CMS - ADV - BEGIN
    ...
    'BLOCK_MOVE' => 'Verschiebe Block',
    'TURN_ACTIVE' => 'Aktiviere/Deaktiviere Block',
    'TURN_BORDER' => 'Enable/Disable Border',
    'TURN_TITLEBAR' => 'Enable/Disable Title Bar',
    'TURN_LOCAL' => 'Enable/Disable Location Title',
    'TURN_BACKGROUND' => 'Aktiviere/Deaktiviere Hintergrund',
