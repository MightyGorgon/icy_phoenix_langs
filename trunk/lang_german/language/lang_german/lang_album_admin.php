...
// 01 - Configuration
    'Album_config' => 'Album Konfiguration',
    'Album_config_explain' => 'Hier kannst Du die generellen Einstellungen des Albums ändern.',
    'Album_config_updated' => 'Album Konfiguration wurde erfolgreich aktualisiert',
    'Click_return_album_config' => '%sKlicke hier%s, um zur Album Konfiguration zurückzukehren.',
    'Max_pics' => 'Maximale Anzahl Bilder pro Kategorie (-1 = unbegrenzt)',
    'User_pics_limit' => 'Maximale Anzahl Bilder pro Kategorie pro User(-1 = unbegrenzt)',
    ...
    'Personal_gallery' => 'User dürfen eine Persönliche Galerie erstellen',
    'Personal_gallery_limit' => 'Maximale Anzahl von Bildern für jede persönliche Galerie (-1 = unbegrenzt)',
    'Personal_gallery_view' => 'Wer darf persönliche Galerien betrachten (Voreinstellung)',
    ...
    'Email_Notification' => 'Aktiviere E-Mail-Benachrichtung für neue Bilder (nur Admins)',
    'Show_Download' => 'Zeige DOWNLOAD-Knopf (der das Herunterladen der Bilder im ZIP-Format ermöglicht) nur für jene, die UPLOAD-Rechte in dem Album haben (wird IMMER gewählt, ist der Knopf auch für Benutzer ohne UPLOAD-Rechte sichtbar)',
    ...
    'Set_Memory' => 'Setze ein Limit über Php (MB)',
    'Set_Memory_Explain' => 'Dieses Feature kann verwendet werden um die Speicherbegrenzung in PHP zu erhöhen (Diese Einstellung muß durch Deinen Anbieter erlaubt werden): falls Deine Bilder nicht richtig geladen werden, kannst Du versuchen den Speicher zu erhöhen. Der Maximalwert wird hier bei 16 MB festgelegt.',
    ...
    'Show_Last_Comments' => 'Zeige letzte Kommentare im Album Index und Kategorien',
    ...
    'Show_Personal_Gallery_Link' => 'Zeige Persönliche Galerien und den dazugehörigen Link in den Unterkategorien',
    'Album_Personal_Auth_Explain' => 'Hier kannst Du wählen, welche Benutzergruppe(n) Moderator für <b>alle</b> persönlichen Albenkategorien sind oder einfach nur persönlichen Zugriff zu ihnen hat.',
    ...
    'Enable_Show_All_Pics' => 'Aktiviert die Ansicht wie in den persönlichen Galerien (alle Kategorien oder nur die derzeitig gewählte). <br /> Wenn ausgeschaltet, wird nur die gewählte Kategorie angezeigt',
    ...
    'Show_OTF_Link' => 'Zeige "Schnelles Foto Album" Link im Album Index',
    'Show_AllPics_Link' => 'Zeige "Alle Bilder" Link im Album Index',
    'Show_PG_Link' => 'Zeige "Persönliche Galerien der Benutzer" link on Album Index',

// 02 - Personal Galleries
    'Personal_Galleries' => 'Persönliche Galerien',
    'Album_personal_gallery_title' => 'Persönliche Galerie',
    'Album_personal_gallery_explain' => 'Auf dieser Seite kannst Du auswählen, welche Usergruppen eine persönliche Galerie erstellen dürfen. Diese Einstellungen sind nur wirksam, wenn Du für "User dürfen eine Persönliche Galerie erstellen" oder "Wer darf persönliche Galerien betrachten (Voreinstellung)" in der Albumkonfiguration die Einstellung "privat" gewählt hast!',
    'Album_personal_successfully' => 'Die Einstellungen wurden erfolgreich aktualisiert',
    'Click_return_album_personal' => 'Klicke %shier%s, um zu den Einstellungen der persönlichen Galerien zurückzukehren',
    'Allow_Album_Avatars' => 'Erlaube Benutzern ihre Bilder als Avatar zu verwenden',
    'Album_Personal_Settings' => 'Persönliche Galerien',
    ...
    'Personal_Gallery_MOD' => 'Persönliche Galerien können vom Benutzer administriert werden',
    'Personal_Sub_Cat_Limit' => 'Maximale Anzahl an Unterkategorien (-1 = unbegrenzt)',
    'User_Can_Create_Personal_SubCats' => 'Benutzer können Unterkategorien in ihren persönlichen Galerien erstellen',
    'Click_return_personal_gallery_index' => 'Klicke %shier%s, um zu den persönlichen Galerien zurückzukehren',
    'Show_Recent_In_Personal_Subcats' => 'Zeige die neusten Bilder in den persönlichen Unterkategorien',
    'Show_Recent_Instead_of_Personal_NoPics' => 'Zeige die neusten Bilder anstelle von \'Keine Bilder\' in den persönlichen Galerien',

// 03 - Categories
    'Categories' => 'Album Kategorien',
    'Album_Categories_Title' => 'Album Kategorien Kontrolle',
    ...
    'Click_return_album_category' => 'Klick %shier%s um zur Album-Kategorien-Verwaltung zurückzukehren',
    ...
    'Personal_Root_Gallery' => 'Grundverzeichnis der persönlichen Galerie',
...
// 04 - Permissions
    ...
    'Album_Auth_Explain' => 'Hier kannst Du festlegen, welche Usergruppe(n) in welchen Kategorien Moderator(en) sein sollen, oder ob sie nur persönlichen Zugang zu bestimmten Kategorien haben sollen',
    'Select_a_Category' => 'Wähle eine Kategorie!',
    'Look_up_Category' => 'Kategorie ansehen',
    'Album_Auth_successfully' => 'Auth wurde erfolgreich aktualisiert',
    'Click_return_album_auth' => 'Klick %shier%s um zu Album-Berechtigungen zurückzukehren',
    'Upload' => 'Upload',
    'Rate' => 'Bewerten',
    'Comment' => 'Kommentar',
...
// CLowN
    ...
    'SP_Rate_type' => 'Wähle Bild-Wertungsanzeige',
