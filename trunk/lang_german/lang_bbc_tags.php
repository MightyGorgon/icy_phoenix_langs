...
*
* @package Icy Phoenix
* @version $Id: lang_bbc_tags.php 49 2008-09-15 20:00:00Z TheSteffen $
...
<li><span class="topic_imp">Ja, im Moment sind einige kostenlose Templates (einige davon mit unterschiedlichen Farbenvariationen) worhanden und wir arbeiten weiterhin an Neuen. Wenn du an neuen Templates interessiert bist, solltest du regelmäßig das <a class="post-url" href="http://www.icyphoenix.com/" target="_blank">Support Forum</a> besuchen.</span><br /><br /></li>
...
Credits für alle verwendeten MODs und ihre Autoren können unter diesem Link gefunden werden: <a class="post-url" href="http://www.icyphoenix.com/hacks_list.php" target="_blank">Credits</a>.<br /><br />
...
<ol type="1">
<li>Entpacke Icy Phoenix Paket in einen Ordner auf deiner Festplatte.</li>
<li>Kopiere alle Icy Phoenix Dateien in einen Ordner auf dem Webserver (z.B. /icyphoenix/)</li>
<li>
Setze die Berechtigungen der folgenden Dateien und Ordner auf <span class="text_red"><b>CHMOD 777</b></span>:<br />
<ul>
<li><b>backup/</b></li>
<li><b>cache/</b></li>
<li><b>cache/sql/</b></li>
...
<li>
Setze die Berechtigungen der folgenden Dateien auf <span class="text_red"><b>CHMOD 666</b></span>:<br />
<ul>
...
<li>Rufe die Setup-Datei vom Installations-Ordner auf: <b>install/install.php</b> (z.B. <a class="post-url" href="http://www.mysite.com/icyphoenix/install/install.php">http://www.mysite.com/forum/install/install.php</a>)</li>
<li>Befolge alle Anweisungen auf deinem Bildschirm, gib alle geforderten Daten ein und vervollständige das Setup.</li>
<li>Lösche den <b>install</b> Ordner oder benenne ihn um.</li>
<li>Passe alle Dateien und die Datenbank an deine Wünschen an (einige Dateien müssen von Hand angepaßt werden, während die meisten Optionen im Admin-Bereich und CMS einstellbar sind).</li>
...
Wenn du bereits phpBB verwendest, kannst du dein Forum einfach aktualisieren, indem du die folgenden Schritte durchführst:<br />
<ol type="1">
<li><span class="text_red">Erstelle ein vollständiges Backup aller Dateien und der Datenbank</span> (Wenn du kein Backup hast, frage nicht nach Support! <img src="http://www.icyphoenix.com/images/smiles/icon_mrgreen.gif" alt="Backup Rules!" title="Backup Rules!" />)</li>
...
<li>Prüfe noch einmal, dass dein Backup in Ordnung ist und speichere es an einem sicheren Ort. <img src="http://www.icyphoenix.com/images/smiles/icon_mrgreen.gif" alt="Backup Rules!" title="Backup Rules!" /></li>
<li>Melde dich als Administrator an.</li>
<li>Entpacke Icy Phoenix Paket in einen Ordner auf deiner Festplatte.</li>
<li>Lade die Datei <b>update_to_ip.php</b> hoch und rufe sie im Browser auf (sie ist im <b>install</b> Ordner und muß ins Stammverzeichnis deines phpbb Forums) (z.B. http://www.mysite.com/phpbb/update_to_ip.php). Achtung, falls die Datei <b>update_to_ip.php</b> nicht im Stammverzeichnis deines Forums ist, wird das Update nicht richtig funktionieren.</li>
<li>Lösche die <b>update_to_ip.php</b> Datei.</li>
<li>Lösche die folgenden Ordner (vergewissere dich, dass du in diesen Ordnern keine Dateien hast, die du für einige von dir installierte mods benötigst. Aber für solche Fälle solltest du ja ein Backup machen. <img src="http://www.icyphoenix.com/images/smiles/icon_mrgreen.gif" alt="Backup Rules!" title="Backup Rules!" />):
<ul>
<li><b>admin</b></li>
<li><b>db</b></li>
<li><b>includes</b></li>
...
<li>Lösche <b>alle Dateien</b> außer die <b>config.php</b> (vergewissere dich, dass du in diesen Ordnern keine Dateien hast, die du für einige von dir installierte mods benötigst. Aber für solche Fälle solltest du ja ein Backup machen.) <img src="http://www.icyphoenix.com/images/smiles/icon_mrgreen.gif" alt="Backup Rules!" title="Backup Rules!" />).</li>
<li>Lade alle Icy Phoenix Dateien in das selbe Verzeichnis hoch, wo dein phpBB installiert ist (alle Dateien außer <b>config.php</b>). Achte darauf, dass alle älteren Dateien mit den neuen ersetzt werden.</li>
<li>Setzte alle Berechtigungen wie bei Neuinstallation beschrieben.</li>
<li>Passe alle Dateien und die Datenbank an deine Wünschen an (einige Dateien müssen von Hand angepaßt werden, während die meisten Optionen im Admin-Bereich und CMS einstellbar sind).</li>
<li>Aktiviere dein Board wieder.</li>
...
$lang['BBC_Upgrade_XS'] = '
Wenn du bereits phpBB XS verwendest, kannst du dein Forum einfach aktualisieren, indem du die folgenden Schritte durchführst (basierend auf phpBB XS 058 Standard-Setup):<br />
<ol type="1">
<li><span class="text_red">Erstelle ein vollständiges Backup aller Dateien und der Datenbank</span> (Wenn du kein Backup hast, frage nicht nach Support! <img src="http://www.icyphoenix.com/images/smiles/icon_mrgreen.gif" alt="Backup Rules!" title="Backup Rules!" />)</li>
<li>Hast du ein Backup von allem? Wenn du kein Backup hast, gehe zum vorhergehenden Punkt zurück.</li>
<li>Kopiere deine aktuellen Dateien (<b>.htaccess</b>, <b>config.php</b>, <b>includes/def_themes.php</b>, <b>includes/def_tree.php</b>, <b>includes/def_words.php</b>) und speichere sie an einem sicheren Ort.</li>
<li>Prüfe noch einmal, dass dein Backup in Ordnung ist und speichere es an einem sicheren Ort. <img src="http://www.icyphoenix.com/images/smiles/icon_mrgreen.gif" alt="Backup Rules!" title="Backup Rules!" />
<li>Melde dich als Administrator an.</li>
<li>Deaktiviere dein Board.</li>
<li>Entpacke Icy Phoenix Paket in einen Ordner auf deiner Festplatte.</li>
<li>Lade die Datei <b>update_to_ip.php</b> hoch und rufe sie im Browser auf (sie ist im <b>install</b> Ordner und muß ins Stammverzeichnis deines phpbb Forums) (z.B. http://www.mysite.com/phpbb/update_to_ip.php). Achtung, falls die Datei <b>update_to_ip.php</b> nicht im Stammverzeichnis deines Forums ist, wird das Update nicht richtig funktionieren.</li>
<li>Lösche die <b>update_to_ip.php</b> Datei.</li>
<li>Verschiebe den nachstehenden Ordner:
<ul>
...
$lang['BBC_Upgrade_IP'] = '
Wenn du bereits Icy Phoenix 1.0.9.9 verwendest, kannst du dein Forum einfach aktualisieren, indem du die folgenden Schritte durchführst:<br />
<ol type="1">
<li><span class="text_red">Erstelle ein vollständiges Backup aller Dateien und der Datenbank</span> (Wenn du kein Backup hast, frage nicht nach Support! <img src="http://www.icyphoenix.com/images/smiles/icon_mrgreen.gif" alt="Backup Rules!" title="Backup Rules!" />)</li>
<li>Hast du ein Backup von allem? Wenn du kein Backup hast, gehe zum vorhergehenden Punkt zurück.</li>
<li>Kopiere deine aktuellen Dateien (<b>.htaccess</b>, <b>config.php</b>, <b>includes/def_themes.php</b>, <b>includes/def_tree.php</b>, <b>includes/def_words.php</b>) und speichere sie an einem sicheren Ort.</li>
...
<ul>
<li><b>adm</b></li>
<li><b>includes</b> (außer <b>includes/def_themes.php</b>, <b>includes/def_tree.php</b> und <b>includes/def_words.php</b>)</li>
<li><b>language</b></li>
<li><b>templates</b></li>
</ul>
</li>
