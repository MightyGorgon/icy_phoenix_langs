...
*
* @package Icy Phoenix
* @version $Id: lang_bbcode.php 49 2008-09-15 20:00:00Z TheSteffen $
...
$faq[] = array("Das Linken zu einer Site", "phpBB BBCode unterstützt eine Menge verschiedener Möglichkeiten, wie man Internet-Adressen (URLs) einfügen kann.<ul><li>Die erste Möglichkeit ist die Verwendung des<b>[url=][/url]</b>-Tag. Was auch immer du hinter das = Zeichen schreibst, wird als Inhalt der URL gewertet. Ein Beispiel: einen Link zu caromonline.de erstellst du so:<br /><br /><b>[url=http://www.caromonline.de/]</b>Besucht caromonline.de!<b>[/url]</b><br /><br />Das würde den folgenden Link erstellen: <a href=\"http://www.caromonline.de/\" target=\"_blank\">Besucht caromonline.de!</a>. Du wirst bemerken, dass sich der Link in einem neuen Fenster öffnet, so dass der Benutzer weiter im Forum surfen kann, sofern er dies wünscht.</li><li>Falls du möchtest, dass die URL automatisch als Link angezeigt wird, kannst du das folgendermaßen schreiben:<br /><br /><b>[url]</b>http://www.caromonline.de/<b>[/url]</b><br /><br />Dies wird den folgenden Link erzeugen: <a href=\"http://www.caromonline.de/\" target=\"_blank\">http://www.caromonline.de/</a></li><li>Zusätzlich verfügt phpBB über die so genannten <i>Magic Links</i>, was automatisch korrekt angegebene URLs in Links umwandelt, ohne dass du Tags schreiben musst. Wenn du zum Beispiel www.caromonline.de in einen Beitrag schreibst, wird daraus automatisch <a href=\"http://www.caromonline.de/\" target=\"_blank\">www.caromonline.de</a>, wenn jemand die Nachricht liest.</li><li>Dies funktioniert übrigens auch mit E Mail-Adressen, du kannst entweder eine Adresse gesondert eingeben, z. B.:<br /><br /><b>[email]</b>webmaster@caromonline.de<b>[/email]</b><br /><br />was das Folgende ergibt <a href=\"mailto:webmaster@caromonline.de\">webmaster@caromonline.de</a> oder du schreibst einfach webmaster@caromonline.de in deinen Beitrag und es wird automatisch in einen Link umgewandelt.</li></ul>Wie die meisten anderen BBCode-Tags, kannst du auch den URL-Tag mit anderen Tags kombinieren, z. B. <b>[img][/img]</b> (siehe nächsten Punkt), <b>[b][/b]</b>, usw. Es ist wie immer deine Aufgabe, dass alle geöffneten Tags auch wieder richtig geschlossen werden, z. B.<br /><br /><b>[url=http://www.caromonline.de/][img]</b>http://www.caromonline.de/images/google.png<b>[/url][/img]</b><br /><br />ist <u>nicht</u> richtig und wird einen Fehler in deinem Beitrag auslösen.");


$faq[] = array("--", "Bilder in Beiträgen anzeigen");
$faq[] = array("Ein Bild einfügen", "Der phpBB BBCode unterstützt ebenfalls das Einfügen von Bildern in Beiträgen. Es gibt zwei wichtige Regeln, was das Anzeigen von Bildern betrifft: Die meisten User finden es einfach furchtbar, wenn endlos Bilder in den Beiträgen stehen (Stichwort Ladezeiten) und zum anderen muss das Bild bereits irgendwo im Internet hochgeladen sein (es bringt also nichts, wenn die Datei nur auf deiner Festplatte liegt, sofern du keinen Webserver hast!). Momentan gibt es noch keine Möglichkeit, Bilder mit Hilfe von phpBB lokal zu speichern (das könnte sich mit der nächsten Version von phpBB 2 natürlich ändern). Um ein Bild anzuzeigen, muss die URL des Bildes mit den <b>[img][/img]</b>-Tags umschlossen werden. Zum Beispiel:<br /><br /><b>[img]</b>http://www.caromonline.de/images/google.png<b>[/img]</b><br /><br />Wie bei der URL-Erklärung bereits erwähnt, kannst du Bilder in <b>[url][/url]</b>-Tags einschließen, wenn du möchtest, z. B. <br /><br /><b>[url=http://www.caromonline.de/][img]</b>http://www.caromonline.de/images/google.png<b>[/img][/url]</b><br /><br />würde Folgendes ergeben:<br /><br /><a href=\"http://www.caromonline.de/\" target=\"_blank\"><img src=\"/images/google.png\" border=\"0\" alt=\"\" /></a><br />");
