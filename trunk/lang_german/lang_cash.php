...
*
* @package Icy Phoenix
* @version $Id: lang_cash.php 49 2008-09-15 20:00:00Z TheSteffen $
...
*/
$lang['Cash_clause'][CASH_LOG_DONATE] = '<a href="' . $IP_ROOT_PATH . PROFILE_MG . '?mode=viewprofile&amp;' . POST_USERS_URL . '=%s" target="_new"><b>%s</b></a> verschenkte <b>%s</b> an <a href="' . $phpbb_root_path . PROFILE_MG . '?mode=viewprofile&amp;' . POST_USERS_URL . '=%s" target="_new"><b>%s</b></a>';
...
Set 3 points
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_MODEDIT] = '<a href="' . $IP_ROOT_PATH . PROFILE_MG . '?mode=viewprofile&amp;' . POST_USERS_URL . '=%s" target="_new">%s</a> änderte <a href="' . $phpbb_root_path . PROFILE_MG . '?mode=viewprofile&amp;' . POST_USERS_URL . '=%s" target="_new"><b>%s</b></a>\'s Kontostand:<br />Fügte <b>%s</b><br />Entfernte <b>%s</b><br />Setzte Kontostand auf <b>%s</b>';
...
Joe deleted $
*/
$lang['Cash_clause'][CASH_LOG_ADMIN_DELETE_CURRENCY] = '<a href="' . $IP_ROOT_PATH . PROFILE_MG . '?mode=viewprofile&amp;' . POST_USERS_URL . '=%s" target="_new"><b>%s</b></a> löschte <b>%s</b>';
