...
*/
	...
	'HELP_Dl_report_broken_vc' => 'Activa una confirmación visual si el usuario está reportando un enlace roto.<br />Solamente se guardará el reporte si el código introducido es correcto y se informará sobre esto a los administradores y moderadores de descargas mediante un email.',
...
*/
	...
	'HELP_Dl_must_approve' => 'Active esta opción para que sea necesario aprobar cada nueva descarga antes de que sea mostrada en su categoría.<br />Los administradores y moderadores de descargas recibirán emails con cada nueva descarga sin aprobar.',
...
*/
	...
	'HELP_Dl_no_change_edit_time' => 'Marque esta opción para no actualizar la última modificación de esta descarga.<br />Esto no afecta al email ni a la notificación por popup/mensaje en el encabezado.',
	'HELP_Dl_disable_popup_files' => 'Marque esta opción para no notificar de este cambio por popup/mensaje en el encabezado.<br />Esto no afecta al email de notificación.',
	'HELP_Dl_disable_email_files' => 'Marque esta opción para no notificar de este cambio por email.<br />Esto no afecta a la notificación por popup/mensaje en el encabezado.',
	...
	'HELP_Dl_hack_autor_email' => 'La dirección de email del autor.<br />Si no lo introduce aquí, ésto no se mostrará en los detalles de descarga ni en la vista general.',
